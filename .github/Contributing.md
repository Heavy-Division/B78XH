`Contributing.md template author: FlyByWire Simulations`

# Welcome

Welcome to the [B78XH] project repository. Thank you for your interest in contributing to the project. Full details and guidelines on how to ensure this project is managed well are included below.
...
```shell
git clone https://github.com/Heavy-Division/B78XH.git
cd B78XH
...
If you require **support** with the B78XH, please utilise the channels on our official [Discord](https://discord.gg/Heavydivision). Issues regarding the features or bugs will not be handled on Discord. Please use GitHub issues to track new features or bugs.
...
If you wish to add a new feature or you spot a bug that you wish to fix, **please open an issue for it first** on the [B78XH issue tracker](https://github.com/Heavy-Division/B78XH/issues).
