 ...
 */
declare class ClimbSpeed extends Speed {
}

/**
 * Waypoint speed definition
 */
declare class WaypointSpeed extends Speed {
	constructor(speed: any, speedMach: any);

	_speedMach: any;
	set speedMach(arg: number);
 ...
 */
declare class CruiseSpeed extends Speed {
	constructor(speed: any, speedMach: any);
 ...
 */
declare class DescentSpeed extends Speed {
}

declare class OverspeedProtection extends Speed {
	/**
	 * Flap protection speeds table
	 * @param handleIndex
	 * @returns {number}
	 */
	getFlapProtectionMaxSpeed(handleIndex: any): number;
}

declare class SpeedRestriction extends Speed {
	constructor(speed: any, altitude: any);
...
declare class AccelerationSpeedRestriction extends SpeedRestriction {
	constructor(speed: any, altitude: any, height: any);

	_accelerationHeight: number;
	/**
	 * Acceleration height setter
	 * Suggestion: Should be renamed to "height"??
	 * @param height
	 */
	set accelerationHeight(arg: number);
	/**
...
declare class ClimbSpeedRestriction extends SpeedRestriction {
}

declare class DescentSpeedRestriction extends SpeedRestriction {
}

declare class SpeedTransition extends SpeedRestriction {
	constructor(speed?: number, altitude?: number, isDeleted?: boolean);

	_isDeleted: boolean;
	set isDeleted(arg: boolean);
	get isDeleted(): boolean;
}

declare class DescentSpeedTransition extends SpeedTransition {
}

declare class ClimbSpeedTransition extends SpeedTransition {
}
