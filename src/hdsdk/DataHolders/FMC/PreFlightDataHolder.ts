export class PreFlightDataHolder {
    private _completed: boolean;
    private _finished: boolean;
    private _thrustLim: ThrustLimPagePreFlightCheck;
    private _takeOff: TakeOffPagePreFlightCheck;
    private _perfInit: PerfInitPagePreFlightCheck;
    private _route: RoutePagePreFlightCheck;
    /**
...
export class ThrustLimPagePreFlightCheck {
    private _completed: boolean;
    private _assumedTemperature: boolean;
    /**
...
export class TakeOffPagePreFlightCheck {
    private _completed: boolean;
    private _flaps: boolean;
    private _v1: boolean;
    private _vR: boolean;
    private _v2: boolean;
    /**
...
export class PerfInitPagePreFlightCheck {
    private _completed: boolean;
    private _cruiseAltitude: boolean;
    private _costIndex: boolean;
    private _reserves: boolean;
    /**
...
export class RoutePagePreFlightCheck {
    private _completed: boolean;
    private _origin: boolean;
    private _destination: boolean;
