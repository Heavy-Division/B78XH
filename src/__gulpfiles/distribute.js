...
const paths = {
	sdk: ['dist/hdsdk.js', '../html_ui/Heavy/libs'],
	logger: ['dist/hdlogger.js', '../html_ui/Heavy/libs'],
	fmc: ['dist/hdfmc.js', '../html_ui/Pages/VCockpit/Instruments/Airliners/B787_10/FMC']
};
