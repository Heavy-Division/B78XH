class Jet_PFD_AltimeterIndicator extends HTMLElement {
    ...
    construct_AS01B() {
        ...
        this.targetAltitudeTextSVG1.setAttribute("fill", (this.isHud) ? "lime" : "#fdb4fe");
        this.targetAltitudeTextSVG1.setAttribute("font-size", (this.fontSize * 1.6).toString());
        ...
        this.targetAltitudeTextSVG2.setAttribute("width", width.toString());
        this.targetAltitudeTextSVG2.setAttribute("fill", (this.isHud) ? "lime" : "#fdb4fe");
        this.targetAltitudeTextSVG2.setAttribute("font-size", (this.fontSize * 1.3).toString());
        ...
        this.centerSVG.setAttribute("viewBox", "0 0 " + (width + arcWidth) + " " + height);
        {
            ...
            this.groundRibbonHasFixedHeight = true;
            var groundRibbonPosX = _left;
            var groundRibbonPosY = 1;
            var groundRibbonWidth = _width;
            var groundRibbonHeight = 45;
            if (!this.groundRibbonSVG) {
                this.groundRibbonSVG = document.createElementNS(Avionics.SVG.NS, "svg");
                this.groundRibbonSVG.setAttribute("id", "GroundRibbonGroup");
            }
            ...
            this.targetAltitudeIndicatorSVG.setAttribute("viewBox", "0 0 100 100");
            {
                if (!this.targetAltitudeIndicatorSVGShape)
                    this.targetAltitudeIndicatorSVGShape = document.createElementNS(Avionics.SVG.NS, "path");
                this.targetAltitudeIndicatorSVGShape.setAttribute("fill", "none");
                this.targetAltitudeIndicatorSVGShape.setAttribute("stroke", (this.isHud) ? "lime" : "#fdb4fe");
                this.targetAltitudeIndicatorSVGShape.setAttribute("stroke-width", "2");
            ...
            this.cursorSVG.setAttribute("viewBox", "0 0 " + cursorWidth + " " + cursorHeight);
            {
                ...
                this.cursorSVGShape.setAttribute("stroke-width", this.strokeSize);
                this.cursorSVG.appendChild(this.cursorSVGShape);
                this.cursorIntegrals[0].construct(this.cursorSVG, _cursorPosX + 19, _cursorPosY, _width, "BoeingEICAS", this.fontSize * 1.6, (this.isHud) ? "lime" : "white");
                this.cursorIntegrals[1].construct(this.cursorSVG, _cursorPosX + 44, _cursorPosY, _width, "BoeingEICAS", this.fontSize * 1.6, (this.isHud) ? "lime" : "white");
                this.cursorIntegrals[2].construct(this.cursorSVG, _cursorPosX + 69, _cursorPosY, _width, "BoeingEICAS", this.fontSize * 1.6, (this.isHud) ? "lime" : "white");
                this.cursorDecimals.construct(this.cursorSVG, _cursorPosX + 104, _cursorPosY, _width, "BoeingEICAS", this.fontSize * 1.15, (this.isHud) ? "lime" : "white");
                if (!this.cursorSVGAltitudeLevelShape)
                    this.cursorSVGAltitudeLevelShape = document.createElementNS(Avionics.SVG.NS, "rect");
                this.cursorSVGAltitudeLevelShape.setAttribute("fill", (this.isHud) ? "lime" : "#64ec28");
                this.cursorSVGAltitudeLevelShape.setAttribute("x", "18");
                this.cursorSVGAltitudeLevelShape.setAttribute("y", ((cursorHeight * 0.62) * 0.45).toString());
                this.cursorSVGAltitudeLevelShape.setAttribute("width", "20");
                this.cursorSVGAltitudeLevelShape.setAttribute("height", (cursorHeight * 0.4).toString());
                this.cursorSVG.appendChild(this.cursorSVGAltitudeLevelShape);
            }
        ...
        mtrsGroup.setAttribute("id", "MetersGroup");
        {
            ...
            this.mtrsSelectedGroup.setAttribute("id", "SelectedGroup");
            {
                ...
                this.mtrsSelectedSVGText.setAttribute("fill", (this.isHud) ? "lime" : "#c073d6");
                this.mtrsSelectedSVGText.setAttribute("font-size", (this.fontSize * 1.2).toString());
                ...
                mtrsSelectedSVGUnit.setAttribute("fill", (this.isHud) ? "lime" : "#c073d6");
                mtrsSelectedSVGUnit.setAttribute("font-size", (this.fontSize * 0.9).toString());
            ...
            this.mtrsCursorGroup.setAttribute("viewBox", "0 0 " + mtrsCursorWidth + " " + mtrsCursorHeight);
            {
                ...
                mtrsCursorSVGUnit.setAttribute("x", "110");
                mtrsCursorSVGUnit.setAttribute("y", (mtrsCursorHeight * 0.84).toString());
                mtrsCursorSVGUnit.setAttribute("fill", (this.isHud) ? "lime" : "#c073d6");
                mtrsCursorSVGUnit.setAttribute("font-size", (this.fontSize * 0.9).toString());
        ...
        this.minimumReferenceModeText.setAttribute("x", "62");
        this.minimumReferenceModeText.setAttribute("y", (posY + height - 45).toString());
        this.minimumReferenceModeText.setAttribute("fill", (this.isHud) ? "lime" : "#64ec28");
        this.minimumReferenceModeText.setAttribute("font-size", (this.fontSize * 0.9).toString());
        ...
        this.minimumReferenceValueText.setAttribute("x", "62");
        this.minimumReferenceValueText.setAttribute("y", (posY + height - 15).toString());
        this.minimumReferenceValueText.setAttribute("fill", (this.isHud) ? "lime" : "#64ec28");
        this.minimumReferenceValueText.setAttribute("font-size", (this.fontSize).toString());
        ...
        this.minimumReferenceCursor.setAttribute("fill", "none");
        this.minimumReferenceCursor.setAttribute("d", "M 25 0 L 2 25 L 2 -25 L 25 0 L 120 0");
        this.minimumReferenceCursor.setAttribute("stroke", (this.isHud) ? "lime" : "#64ec28");
        this.minimumReferenceCursor.setAttribute("stroke-width", this.strokeSize);
        this.centerSVG.appendChild(this.minimumReferenceCursor);
        if (!this.pressureSVG)
            this.pressureSVG = document.createElementNS(Avionics.SVG.NS, "text");
        ...
        this.pressureSVG.setAttribute("fill", (this.isHud) ? "lime" : "#64ec28");
