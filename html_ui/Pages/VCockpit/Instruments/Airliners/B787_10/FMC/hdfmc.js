(function (global, factory) {
	...
	var SpeedRepository$1 = {};

	Object.defineProperty(SpeedRepository$1, "__esModule", { value: true });
	SpeedRepository$1.SpeedRepository = void 0;
	...
	SpeedRepository$1.SpeedRepository = SpeedRepository;
	...
	exports.VSpeedType = void 0;
	(function (VSpeedType) {
	    VSpeedType[VSpeedType["v1"] = 0] = "v1";
	    VSpeedType[VSpeedType["vR"] = 1] = "vR";
	    VSpeedType[VSpeedType["v2"] = 2] = "v2";
	})(exports.VSpeedType || (exports.VSpeedType = {}));
	}(VSpeedType));

	Object.defineProperty(SpeedManager$1, "__esModule", { value: true });
	SpeedManager$1.SpeedManager = void 0;
	const VSpeedType_1 = VSpeedType;
	class SpeedManager {
	    ...
	    getComputedV1Speed(runway, weight, flaps) {
	        return SpeedManager.getComputedVSpeed(runway, weight, flaps, VSpeedType_1.VSpeedType.v1);
	    }
	    getComputedVRSpeed(runway, weight, flaps) {
	        return SpeedManager.getComputedVSpeed(runway, weight, flaps, VSpeedType_1.VSpeedType.vR);
	    }
	    getComputedV2Speed(runway, weight, flaps) {
	        return SpeedManager.getComputedVSpeed(runway, weight, flaps, VSpeedType_1.VSpeedType.v2);
	    }
	...
	SpeedManager$1.SpeedManager = SpeedManager;
	SpeedManager._v1s = [
	    [130, 156],
	    [128, 154],
	    [127, 151],
	...
	var SpeedCalculator$1 = {};

	Object.defineProperty(SpeedCalculator$1, "__esModule", { value: true });
	SpeedCalculator$1.SpeedCalculator = void 0;
	...
	SpeedCalculator$1.SpeedCalculator = SpeedCalculator;
	...
	logger.HDLogger = void 0;
	const level_1$9 = level;
	class HDLogger {
	    static log(message, level = level_1$9.Level.none) {
	...
	logger.HDLogger = HDLogger;
	HDLogger.handlers = [];

	var ConsoleHandler$1 = {};

	Object.defineProperty(ConsoleHandler$1, "__esModule", { value: true });
	ConsoleHandler$1.ConsoleHandler = void 0;
	const level_1$8 = level;
	class ConsoleHandler {
	    log(message, level = level_1$8.Level.none) {
	        switch (level) {
	            case level_1$8.Level.none:
	                console.log(message);
	                break;
	            case level_1$8.Level.debug:
	                console.log(level_1$8.Level[level] + ': ' + message);
	                break;
	            case level_1$8.Level.info:
	                console.log(level_1$8.Level[level] + ': ' + message);
	                break;
	            case level_1$8.Level.warning:
	                console.warn(level_1$8.Level[level] + ': ' + message);
	                break;
	            case level_1$8.Level.error:
	                console.warn(level_1$8.Level[level] + ': ' + message);
	                break;
	            case level_1$8.Level.fatal:
	                console.warn(level_1$8.Level[level] + ': ' + message);
	                break;
	        }
	    }
	}
	ConsoleHandler$1.ConsoleHandler = ConsoleHandler;

	var SocketIOHandler$1 = {};
	...
	url$1.url = void 0;
	const parseuri_1$1 = __importDefault$a(parseuri);
	const debug_1$7 = __importDefault$a(browser$1.exports); // debug()
	const debug$7 = debug_1$7.default("socket.io-client:url"); // debug()
	/**
	 * URL parser.
	 *
	 * @param uri - url
	...
	const has_cors_1 = __importDefault$9(hasCors.exports);
	const globalThis_js_1$3 = __importDefault$9(globalThis_browser);
	...
	const globalThis_js_1$2 = __importDefault$8(globalThis_browser);
	...
	const base64_arraybuffer_1 = require$$1;
	...
	const debug_1$6 = __importDefault$7(browser.exports); // debug()
	...
	const debug_1$5 = __importDefault$6(browser.exports); // debug()
	const yeast_1$1 = __importDefault$6(yeast_1$2);
	const parseqs_1$2 = __importDefault$6(parseqs);
	...
	const xmlhttprequest_js_1 = __importDefault$5(xmlhttprequest_browser);
	const debug_1$4 = __importDefault$5(browser.exports); // debug()
	const globalThis_js_1$1 = __importDefault$5(globalThis_browser);
	const util_js_1$2 = util;
	const component_emitter_1$3 = componentEmitter;
	const polling_js_1 = polling;
	const debug$4 = (0, debug_1$4.default)("engine.io-client:polling-xhr"); // debug()
	/**
	 * Empty function
	 */
	function empty() { }
	...
	const globalThis_js_1 = __importDefault$4(globalThis_browser);
	...
	const parseqs_1$1 = __importDefault$3(parseqs);
	const yeast_1 = __importDefault$3(yeast_1$2);
	const util_js_1$1 = util;
	const websocket_constructor_js_1 = websocketConstructor_browser;
	const debug_1$3 = __importDefault$3(browser.exports); // debug()
	const engine_io_parser_1$1 = cjs$1;
	const debug$3 = (0, debug_1$3.default)("engine.io-client:websocket"); // debug()
	...
	const parseqs_1 = __importDefault$2(parseqs);
	const parseuri_1 = __importDefault$2(parseuri);
	...
	const debug$2 = (0, debug_1$2.default)("engine.io-client:socket"); // debug()
	...
	const is_binary_js_1 = isBinary$1;
	const debug_1 = browser$1.exports; // debug()
	...
	const debug_1$1 = __importDefault$1(browser$1.exports); // debug()
	...
	const on_js_1 = on$1;
	const backo2_1 = __importDefault(backo2);
	const component_emitter_1 = componentEmitter;
	const debug_1 = __importDefault(browser$1.exports); // debug()
	...
	Object.defineProperty(SocketIOHandler$1, "__esModule", { value: true });
	SocketIOHandler$1.SocketIOHandler = void 0;
	const level_1$7 = level;
	const SocketClient = cjs$3.exports;
	class SocketIOHandler {
	    ...
	    log(message, level) {
	        switch (level) {
	            case level_1$7.Level.none:
	            case level_1$7.Level.debug:
	            case level_1$7.Level.info:
	            case level_1$7.Level.warning:
	            case level_1$7.Level.error:
	            case level_1$7.Level.fatal:
	                this.socket.emit('log', JSON.stringify({ message: message, level: level_1$7.Level[level] }));
	                break;
	        }
	    }
	}
	SocketIOHandler$1.SocketIOHandler = SocketIOHandler;
	...
	__exportStar(ConsoleHandler$1, exports);
	__exportStar(SocketIOHandler$1, exports);
	}(hdlogger));
	...
	Object.defineProperty(SimBriefApi$1, "__esModule", { value: true });
	SimBriefApi$1.SimBriefApi = void 0;
	class SimBriefApi {
	    /**
	     * Constructor
	...
	SimBriefApi$1.SimBriefApi = SimBriefApi;

	var SimBriefCredentials$1 = {};

	var HeavyDataStorage$1 = {};

	Object.defineProperty(HeavyDataStorage$1, "__esModule", { value: true });
	HeavyDataStorage$1.HeavyDataStorage = void 0;
	...
	HeavyDataStorage$1.HeavyDataStorage = HeavyDataStorage;
	/**
	...
	Object.defineProperty(SimBriefCredentials$1, "__esModule", { value: true });
	SimBriefCredentials$1.SimBriefCredentials = void 0;
	const HeavyDataStorage_1 = HeavyDataStorage$1;
	class SimBriefCredentials {
	    ...
	    get userName() {
	        if (this._userName) {
	            ...
	            const userName = HeavyDataStorage_1.HeavyDataStorage.get('SIMBRIEF_USERNAME', '');
	            if (userName) {
	     ...
	     */
	    get userId() {
	        return this._userId || Number(HeavyDataStorage_1.HeavyDataStorage.get('SIMBRIEF_USERID', ''));
	    }
	}
	SimBriefCredentials$1.SimBriefCredentials = SimBriefCredentials;

	Object.defineProperty(SimBrief$1, "__esModule", { value: true });
	SimBrief$1.SimBrief = void 0;
	const SimBriefApi_1 = SimBriefApi$1;
	const SimBriefCredentials_1 = SimBriefCredentials$1;
	class SimBrief {
	    /**
	     * Constructor
	     */
	    constructor() {
	        this.credentials = new SimBriefCredentials_1.SimBriefCredentials();
	        this.api = new SimBriefApi_1.SimBriefApi(this.credentials);
	...
	SimBrief$1.SimBrief = SimBrief;

	var SimBriefOceanicWaypointConverter$1 = {};

	Object.defineProperty(SimBriefOceanicWaypointConverter$1, "__esModule", { value: true });
	SimBriefOceanicWaypointConverter$1.SimBriefOceanicWaypointConverter = void 0;
	...
	SimBriefOceanicWaypointConverter$1.SimBriefOceanicWaypointConverter = SimBriefOceanicWaypointConverter;

	var SimBriefNavlogParser$1 = {};
	...
	})(exports.HDFixType || (exports.HDFixType = {}));
	}(HDFixType));
	...
	(function (exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.HDFixStage = void 0;
	(function (HDFixStage) {
	    HDFixStage[HDFixStage["CLB"] = 0] = "CLB";
	    HDFixStage[HDFixStage["CRZ"] = 1] = "CRZ";
	    HDFixStage[HDFixStage["DES"] = 2] = "DES";
	})(exports.HDFixStage || (exports.HDFixStage = {}));
	}(HDFixStage));

	Object.defineProperty(HDFix$1, "__esModule", { value: true });
	HDFix$1.HDFix = void 0;
	const HDFixType_1 = HDFixType;
	const HDFixStage_1 = HDFixStage;
	class HDFix {
	    get ident() {
	        return this._ident;
	    }
	    ...
	    get isCoordinatesWaypoint() {
	        ...
	        if (this.type === HDFixType_1.HDFixType.MISC || this.type === HDFixType_1.HDFixType.WAYPOINT) {
	    ...
	    parseType(value) {
	        switch (value) {
	            case 'wpt':
	                return HDFixType_1.HDFixType.WAYPOINT;
	            case 'apt':
	                return HDFixType_1.HDFixType.AIRPORT;
	            case 'vor':
	                return HDFixType_1.HDFixType.VOR;
	            default:
	                return HDFixType_1.HDFixType.MISC;
	        }
	    }
	    parseStage(value) {
	        switch (value) {
	            case 'CLB':
	                return HDFixStage_1.HDFixStage.CLB;
	            case 'CRZ':
	                return HDFixStage_1.HDFixStage.CRZ;
	            case 'DSC':
	                return HDFixStage_1.HDFixStage.DES;
	            default:
	                return undefined;
	        }
	    }
	...
	Object.defineProperty(HDAirport$1, "__esModule", { value: true });
	HDAirport$1.HDAirport = void 0;
	class HDAirport {
	    constructor(data) {
	        const airport = data;
	...
	HDAirport$1.HDAirport = HDAirport;

	Object.defineProperty(HDOrigin$1, "__esModule", { value: true });
	HDOrigin$1.HDOrigin = void 0;
	const HDAirport_1$1 = HDAirport$1;
	class HDOrigin extends HDAirport_1$1.HDAirport {
	    constructor(data) {
	        super(data.origin);
	    }
	}
	HDOrigin$1.HDOrigin = HDOrigin;

	var HDDestination$1 = {};

	Object.defineProperty(HDDestination$1, "__esModule", { value: true });
	HDDestination$1.HDDestination = void 0;
	const HDAirport_1 = HDAirport$1;
	class HDDestination extends HDAirport_1.HDAirport {
	    constructor(data) {
	        super(data.destination);
	    }
	}
	HDDestination$1.HDDestination = HDDestination;

	var HDNavlogInfo$1 = {};

	Object.defineProperty(HDNavlogInfo$1, "__esModule", { value: true });
	HDNavlogInfo$1.HDNavlogInfo = void 0;
	class HDNavlogInfo {
	    constructor(data) {
	...
	HDNavlogInfo$1.HDNavlogInfo = HDNavlogInfo;

	var HDWeights$1 = {};

	Object.defineProperty(HDWeights$1, "__esModule", { value: true });
	HDWeights$1.HDWeights = void 0;
	class HDWeights {
	    get payload() {
	...
	HDWeights$1.HDWeights = HDWeights;

	var HDFuel$1 = {};

	Object.defineProperty(HDFuel$1, "__esModule", { value: true });
	HDFuel$1.HDFuel = void 0;
	class HDFuel {
	    get taxi() {
	        return this._taxi;
	    }
	...
	HDFuel$1.HDFuel = HDFuel;

	Object.defineProperty(SimBriefNavlogParser$1, "__esModule", { value: true });
	SimBriefNavlogParser$1.SimBriefNavlogParser = void 0;
	const HDFix_1 = HDFix$1;
	const HDOrigin_1 = HDOrigin$1;
	const HDDestination_1 = HDDestination$1;
	const HDNavlogInfo_1 = HDNavlogInfo$1;
	const HDWeights_1 = HDWeights$1;
	const HDFuel_1 = HDFuel$1;
	class SimBriefNavlogParser {
	    ...
	    async parseWaypoints() {
	        ...
	        for (const fix of fixes) {
	            this._fixes.push(new HDFix_1.HDFix(fix));
	        }
	    }
	    use(middleware) {
	    ...
	    async parseOrigin() {
	        this._origin = new HDOrigin_1.HDOrigin(this._rawNavlog);
	    }
	    async parseDestination() {
	        this._destination = new HDDestination_1.HDDestination(this._rawNavlog);
	    }
	    async parseNavlogInfo() {
	        this._info = new HDNavlogInfo_1.HDNavlogInfo(this._rawNavlog);
	    }
	    async parseWeights() {
	        this._weights = new HDWeights_1.HDWeights(this._rawNavlog);
	    }
	    async parseFuel() {
	        this._fuel = new HDFuel_1.HDFuel(this._rawNavlog);
	    }
	}
	SimBriefNavlogParser$1.SimBriefNavlogParser = SimBriefNavlogParser;

	var SimBriefImporter$1 = {};

	Object.defineProperty(SimBriefImporter$1, "__esModule", { value: true });
	SimBriefImporter$1.SimBriefImporter = void 0;
	...
	SimBriefImporter$1.SimBriefImporter = SimBriefImporter;
	...
	Object.defineProperty(SelectKey$1, "__esModule", { value: true });
	SelectKey$1.SelectKey = void 0;
	class SelectKey {
	...
	SelectKey$1.SelectKey = SelectKey;

	var MainKey$1 = {};

	Object.defineProperty(MainKey$1, "__esModule", { value: true });
	MainKey$1.MainKey = void 0;
	class MainKey {
	    constructor(id, container) {
	        this._event = undefined;
	        this.id = undefined;
	...
	MainKey$1.MainKey = MainKey;

	(function (exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.FMCRenderer = void 0;
	const FMCLineType_1 = FMCLineType;
	const SelectKey_1 = SelectKey$1;
	const MainKey_1 = MainKey$1;
	class FMCRenderer {
	    /**
	     * FMC Renderer
	     * @param {HTMLElement} container
	    ...
	    render(data) {
	        for (let i = 0; i <= this.titles.length - 1; i++) {
	            this.setDataToLine(i, data[i * 2], FMCLineType_1.FMCLineType.TITLE);
	            this.titles[i] = this.titles[i].map((value) => {
	                return this.applyMiddlewares(value);
	            });
	        }
	        for (let i = 0; i <= this.lines.length - 1; i++) {
	            this.setDataToLine(i, data[(i * 2) + 1], FMCLineType_1.FMCLineType.LINE);
	    ...
	    setDataToLine(index, data, type) {
	        let target = [];
	        if (type === FMCLineType_1.FMCLineType.LINE) {
	            target = this.lines[index];
	        }
	        else if (type === FMCLineType_1.FMCLineType.TITLE) {
	    ...
	    loadSelectKeys(container) {
	        ...
	        leftKeys.forEach((element) => {
	            this.selectKeys.push(new SelectKey_1.SelectKey(element.id, container));
	        });
	    ...
	    loadMainKeys(container) {
	        ...
	        mainKeys.forEach((element) => {
	            this.mainKeys.push(new MainKey_1.MainKey(element.id, container));
	        });
	    }
	}
	...
	var ColorRendererMiddleware$1 = {};

	Object.defineProperty(ColorRendererMiddleware$1, "__esModule", { value: true });
	ColorRendererMiddleware$1.ColorRendererMiddleware = void 0;
	...
	ColorRendererMiddleware$1.ColorRendererMiddleware = ColorRendererMiddleware;

	var SizeRendererMiddleware$1 = {};

	Object.defineProperty(SizeRendererMiddleware$1, "__esModule", { value: true });
	SizeRendererMiddleware$1.SizeRendererMiddleware = void 0;
	...
	SizeRendererMiddleware$1.SizeRendererMiddleware = SizeRendererMiddleware;

	var SeparatorRendererMiddleware$1 = {};

	Object.defineProperty(SeparatorRendererMiddleware$1, "__esModule", { value: true });
	SeparatorRendererMiddleware$1.SeparatorRendererMiddleware = void 0;
	...
	SeparatorRendererMiddleware$1.SeparatorRendererMiddleware = SeparatorRendererMiddleware;

	var SettableRendererMiddleware$1 = {};

	Object.defineProperty(SettableRendererMiddleware$1, "__esModule", { value: true });
	SettableRendererMiddleware$1.SettableRendererMiddleware = void 0;
	...
	SettableRendererMiddleware$1.SettableRendererMiddleware = SettableRendererMiddleware;

	var HtmlEncodeRendererMiddleware$1 = {};

	Object.defineProperty(HtmlEncodeRendererMiddleware$1, "__esModule", { value: true });
	HtmlEncodeRendererMiddleware$1.HtmlEncodeRendererMiddleware = void 0;
	/**
	...
	HtmlEncodeRendererMiddleware$1.HtmlEncodeRendererMiddleware = HtmlEncodeRendererMiddleware;

	var HtmlDecodeRendererMiddleware$1 = {};

	Object.defineProperty(HtmlDecodeRendererMiddleware$1, "__esModule", { value: true });
	HtmlDecodeRendererMiddleware$1.HtmlDecodeRendererMiddleware = void 0;
	...
	HtmlDecodeRendererMiddleware$1.HtmlDecodeRendererMiddleware = HtmlDecodeRendererMiddleware;

	var SettableHighlighterRendererMiddleware$1 = {};

	Object.defineProperty(SettableHighlighterRendererMiddleware$1, "__esModule", { value: true });
	SettableHighlighterRendererMiddleware$1.SettableHighlighterRendererMiddleware = void 0;
	...
	SettableHighlighterRendererMiddleware$1.SettableHighlighterRendererMiddleware = SettableHighlighterRendererMiddleware;

	var DefaultRendererTemplater$1 = {};

	Object.defineProperty(DefaultRendererTemplater$1, "__esModule", { value: true });
	DefaultRendererTemplater$1.DefaultRendererTemplater = void 0;
	/**
	...
	DefaultRendererTemplater$1.DefaultRendererTemplater = DefaultRendererTemplater;

	var NaturalRendererTemplater$1 = {};

	Object.defineProperty(NaturalRendererTemplater$1, "__esModule", { value: true });
	NaturalRendererTemplater$1.NaturalRendererTemplater = void 0;
	...
	NaturalRendererTemplater$1.NaturalRendererTemplater = NaturalRendererTemplater;
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	__exportStar(FMCRenderer, exports);
	__exportStar(FMCLineType, exports);
	__exportStar(ColorRendererMiddleware$1, exports);
	__exportStar(SizeRendererMiddleware$1, exports);
	__exportStar(SeparatorRendererMiddleware$1, exports);
	__exportStar(SettableRendererMiddleware$1, exports);
	__exportStar(HtmlEncodeRendererMiddleware$1, exports);
	__exportStar(HtmlDecodeRendererMiddleware$1, exports);
	__exportStar(SettableHighlighterRendererMiddleware$1, exports);
	__exportStar(DefaultRendererTemplater$1, exports);
	__exportStar(NaturalRendererTemplater$1, exports);
	}(FMCRendererModule));
	...
	var HDDescentSpeed$1 = {};

	var HDSpeed$1 = {};

	Object.defineProperty(HDSpeed$1, "__esModule", { value: true });
	HDSpeed$1.HDSpeed = void 0;
	class HDSpeed {
	    constructor(speed) {
	...
	HDSpeed$1.HDSpeed = HDSpeed;

	Object.defineProperty(HDDescentSpeed$1, "__esModule", { value: true });
	HDDescentSpeed$1.HDDescentSpeed = void 0;
	const HDSpeed_1$4 = HDSpeed$1;
	class HDDescentSpeed extends HDSpeed_1$4.HDSpeed {
	...
	HDDescentSpeed$1.HDDescentSpeed = HDDescentSpeed;

	var HDAccelerationSpeedRestriction$1 = {};

	var HDSpeedRestriction$1 = {};

	Object.defineProperty(HDSpeedRestriction$1, "__esModule", { value: true });
	HDSpeedRestriction$1.HDSpeedRestriction = void 0;
	const HDSpeed_1$3 = HDSpeed$1;
	class HDSpeedRestriction extends HDSpeed_1$3.HDSpeed {
	...
	HDSpeedRestriction$1.HDSpeedRestriction = HDSpeedRestriction;

	Object.defineProperty(HDAccelerationSpeedRestriction$1, "__esModule", { value: true });
	HDAccelerationSpeedRestriction$1.HDAccelerationSpeedRestriction = void 0;
	const HDSpeedRestriction_1$3 = HDSpeedRestriction$1;
	class HDAccelerationSpeedRestriction extends HDSpeedRestriction_1$3.HDSpeedRestriction {
	...
	HDAccelerationSpeedRestriction$1.HDAccelerationSpeedRestriction = HDAccelerationSpeedRestriction;

	var HDOverspeedProtection$1 = {};

	Object.defineProperty(HDOverspeedProtection$1, "__esModule", { value: true });
	HDOverspeedProtection$1.HDOverspeedProtection = void 0;
	const HDSpeed_1$2 = HDSpeed$1;
	class HDOverspeedProtection extends HDSpeed_1$2.HDSpeed {
	    /**
	     * Speed getter
	     * @returns {number}
	     */
	...
	HDOverspeedProtection$1.HDOverspeedProtection = HDOverspeedProtection;

	var HDClimbSpeedRestriction$1 = {};

	Object.defineProperty(HDClimbSpeedRestriction$1, "__esModule", { value: true });
	HDClimbSpeedRestriction$1.HDClimbSpeedRestriction = void 0;
	const HDSpeedRestriction_1$2 = HDSpeedRestriction$1;
	class HDClimbSpeedRestriction extends HDSpeedRestriction_1$2.HDSpeedRestriction {
	    isValid() {
	        const planeAltitude = Simplane.getAltitude();
	        if (this._speed && isFinite(this._speed) && this._altitude && isFinite(this._altitude)) {
	            if (this._altitude > planeAltitude) {
	...
	HDClimbSpeedRestriction$1.HDClimbSpeedRestriction = HDClimbSpeedRestriction;

	var HDClimbSpeedTransition$1 = {};

	var HDSpeedTransition$1 = {};

	Object.defineProperty(HDSpeedTransition$1, "__esModule", { value: true });
	HDSpeedTransition$1.HDSpeedTransition = void 0;
	const HDSpeedRestriction_1$1 = HDSpeedRestriction$1;
	class HDSpeedTransition extends HDSpeedRestriction_1$1.HDSpeedRestriction {
	...
	HDSpeedTransition$1.HDSpeedTransition = HDSpeedTransition;

	Object.defineProperty(HDClimbSpeedTransition$1, "__esModule", { value: true });
	HDClimbSpeedTransition$1.HDClimbSpeedTransition = void 0;
	const HDSpeedTransition_1$1 = HDSpeedTransition$1;
	class HDClimbSpeedTransition extends HDSpeedTransition_1$1.HDSpeedTransition {
	    constructor(speed = 250, altitude = 10000, isDeleted = false) {
	        super(speed, altitude, isDeleted);
	    }
	}
	HDClimbSpeedTransition$1.HDClimbSpeedTransition = HDClimbSpeedTransition;

	var HDClimbSpeed$1 = {};

	Object.defineProperty(HDClimbSpeed$1, "__esModule", { value: true });
	HDClimbSpeed$1.HDClimbSpeed = void 0;
	const HDSpeed_1$1 = HDSpeed$1;
	class HDClimbSpeed extends HDSpeed_1$1.HDSpeed {
	    constructor(speed) {
	        super(speed);
	    }
	}
	HDClimbSpeed$1.HDClimbSpeed = HDClimbSpeed;

	var HDCruiseSpeed$1 = {};

	Object.defineProperty(HDCruiseSpeed$1, "__esModule", { value: true });
	HDCruiseSpeed$1.HDCruiseSpeed = void 0;
	const HDSpeed_1 = HDSpeed$1;
	class HDCruiseSpeed extends HDSpeed_1.HDSpeed {
	    constructor(speed, speedMach) {
	        super(speed);
	        this._speedMach = Number(speedMach);
	    }
	...
	HDCruiseSpeed$1.HDCruiseSpeed = HDCruiseSpeed;

	var HDDescentSpeedRestriction$1 = {};

	Object.defineProperty(HDDescentSpeedRestriction$1, "__esModule", { value: true });
	HDDescentSpeedRestriction$1.HDDescentSpeedRestriction = void 0;
	const HDSpeedRestriction_1 = HDSpeedRestriction$1;
	class HDDescentSpeedRestriction extends HDSpeedRestriction_1.HDSpeedRestriction {
	    /**
	...
	HDDescentSpeedRestriction$1.HDDescentSpeedRestriction = HDDescentSpeedRestriction;

	var HDDescentSpeedTransition$1 = {};

	Object.defineProperty(HDDescentSpeedTransition$1, "__esModule", { value: true });
	HDDescentSpeedTransition$1.HDDescentSpeedTransition = void 0;
	const HDSpeedTransition_1 = HDSpeedTransition$1;
	class HDDescentSpeedTransition extends HDSpeedTransition_1.HDSpeedTransition {
	    constructor(speed = 240, altitude = 10500, isDeleted = false) {
	        super(speed, altitude, isDeleted);
	    }
	}
	HDDescentSpeedTransition$1.HDDescentSpeedTransition = HDDescentSpeedTransition;

	Object.defineProperty(SpeedDirector$1, "__esModule", { value: true });
	SpeedDirector$1.SpeedDirector = void 0;
	const HDSpeedPhase_1 = HDSpeedPhase;
	const HDSpeedType_1 = HDSpeedType;
	const HDDescentSpeed_1 = HDDescentSpeed$1;
	const HDAccelerationSpeedRestriction_1 = HDAccelerationSpeedRestriction$1;
	const HDOverspeedProtection_1 = HDOverspeedProtection$1;
	const HDClimbSpeedRestriction_1 = HDClimbSpeedRestriction$1;
	const HDClimbSpeedTransition_1 = HDClimbSpeedTransition$1;
	const HDClimbSpeed_1 = HDClimbSpeed$1;
	const HDCruiseSpeed_1 = HDCruiseSpeed$1;
	const HDDescentSpeedRestriction_1 = HDDescentSpeedRestriction$1;
	const HDDescentSpeedTransition_1 = HDDescentSpeedTransition$1;
	class SpeedDirector {
	    ...
	    _initSpeeds() {
	        this._accelerationSpeedRestriction = new HDAccelerationSpeedRestriction_1.HDAccelerationSpeedRestriction(this._speedManager.repository.v2Speed + 10, 1500, 1500);
	        this._overspeedProtection = new HDOverspeedProtection_1.HDOverspeedProtection(undefined);
	        this._climbSpeedRestriction = new HDClimbSpeedRestriction_1.HDClimbSpeedRestriction(undefined, undefined);
	        this._climbSpeedTransition = new HDClimbSpeedTransition_1.HDClimbSpeedTransition();
	        this._climbSpeedSelected = new HDClimbSpeed_1.HDClimbSpeed(undefined);
	        this._climbSpeedEcon = new HDClimbSpeed_1.HDClimbSpeed(this._speedManager.getEconClbManagedSpeed(0));
	        this._cruiseSpeedSelected = new HDCruiseSpeed_1.HDCruiseSpeed(undefined, undefined);
	        this._cruiseSpeedEcon = new HDCruiseSpeed_1.HDCruiseSpeed(this._speedManager.getEconCrzManagedSpeed(0), 0.85);
	        this._descentSpeedRestriction = new HDDescentSpeedRestriction_1.HDDescentSpeedRestriction(undefined, undefined);
	        this._descentSpeedTransition = new HDDescentSpeedTransition_1.HDDescentSpeedTransition();
	        this._descentSpeedSelected = new HDDescentSpeed_1.HDDescentSpeed(undefined, undefined);
	        this._descentSpeedEcon = new HDDescentSpeed_1.HDDescentSpeed(282, undefined);
	    ...
	    get speed() {
	        switch (this.speedPhase) {
	            case HDSpeedPhase_1.HDSpeedPhase.SPEED_PHASE_CLIMB:
	                switch (this.commandedSpeedType) {
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_RESTRICTION:
	                        return this._resolveMachKias(this._climbSpeedRestriction);
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_TRANSITION:
	                        return this._resolveMachKias(this._climbSpeedTransition);
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_SELECTED:
	                        return this._resolveMachKias(this._climbSpeedSelected);
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_ACCELERATION:
	                        return this._resolveMachKias(this._accelerationSpeedRestriction);
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_PROTECTED:
	                    ...
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_ECON:
	                        return this._resolveMachKias(this._climbSpeedEcon);
	                    default:
	                        return 133;
	                }
	            case HDSpeedPhase_1.HDSpeedPhase.SPEED_PHASE_CRUISE:
	                switch (this.commandedSpeedType) {
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_RESTRICTION:
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_TRANSITION:
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_ECON:
	                ...
	                break;
	            case HDSpeedPhase_1.HDSpeedPhase.SPEED_PHASE_DESCENT:
	                switch (this.commandedSpeedType) {
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_RESTRICTION:
	                ...
	                break;
	            case HDSpeedPhase_1.HDSpeedPhase.SPEED_PHASE_APPROACH:
	                switch (this.commandedSpeedType) {
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_RESTRICTION:
	                        return this._resolveMachKias(this._descentSpeedRestriction);
	                    case HDSpeedType_1.HDSpeedType.SPEED_TYPE_TRANSITION:
	    ...
	    _updateClimbSpeed() {
	        let speed = {
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_RESTRICTION]: (this._climbSpeedRestriction && this._climbSpeedRestriction.isValid() ? this._climbSpeedRestriction.speed : false),
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_TRANSITION]: (this._climbSpeedTransition && this._climbSpeedTransition.isValid() ? this._climbSpeedTransition.speed : false),
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_ACCELERATION]: (this._accelerationSpeedRestriction && this._accelerationSpeedRestriction.isValid() ? this._accelerationSpeedRestriction.speed : false),
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_PROTECTED]: (this._overspeedProtection && this._overspeedProtection.isValid() ? this._overspeedProtection.speed : false),
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_SELECTED]: (this._climbSpeedSelected && this._climbSpeedSelected.isValid() ? this._climbSpeedSelected.speed : false),
	            ...
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_ECON]: (this._climbSpeedEcon && this._climbSpeedEcon.isValid() ? this._climbSpeedEcon.speed : false)
	        };
	        ...
	        }, HDSpeedType_1.HDSpeedType.SPEED_TYPE_ECON);
	        commandedSpeedKey = this.shouldCommandSelectedSpeed(commandedSpeedKey, this._climbSpeedSelected);
	        this._updateCommandedSpeed(commandedSpeedKey, HDSpeedPhase_1.HDSpeedPhase.SPEED_PHASE_CLIMB);
	        this._updateMachMode();
	    }
	    shouldCommandSelectedSpeed(commandedSpeedKey, selectedSpeed) {
	        if (Number(commandedSpeedKey) === HDSpeedType_1.HDSpeedType.SPEED_TYPE_ECON) {
	            return selectedSpeed.isValid() ? HDSpeedType_1.HDSpeedType.SPEED_TYPE_SELECTED : HDSpeedType_1.HDSpeedType.SPEED_TYPE_ECON;
	        }
	        else {
	    ...
	    _updateCruiseSpeed() {
	        let speed = {
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_SELECTED]: (this._cruiseSpeedSelected && this._cruiseSpeedSelected.isValid() ? this._cruiseSpeedSelected.speed : false),
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_PROTECTED]: (this._overspeedProtection && this._overspeedProtection.isValid() ? this._overspeedProtection.speed : false),
	            //[SpeedType.SPEED_TYPE_WAYPOINT]: (this._waypointSpeedConstraint && this._waypointSpeedConstraint.isValid() ? this._waypointSpeedConstraint.speed : false),
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_ECON]: (this._cruiseSpeedEcon && this._cruiseSpeedEcon.isValid() ? this._cruiseSpeedEcon.speed : null)
	        };
	        this._updateLastCommandedSpeed();
	        this._updateLastMachMode();
	        let commandedSpeedKey = Object.keys(speed).filter(key => !!speed[key]).reduce((accumulator, value) => {
	        ...
	        this._updateCommandedSpeed(commandedSpeedKey, HDSpeedPhase_1.HDSpeedPhase.SPEED_PHASE_CRUISE);
	        this._updateMachMode();
	    }
	    _updateDescentSpeed() {
	        let speed = {
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_RESTRICTION]: (this._descentSpeedRestriction && this._descentSpeedRestriction.isValid() ? this._descentSpeedRestriction.speed : false),
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_TRANSITION]: (this._descentSpeedTransition && this._descentSpeedTransition.isValid() ? this._descentSpeedTransition.speed : false),
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_PROTECTED]: (this._overspeedProtection && this._overspeedProtection.isValid() ? this._overspeedProtection.speed : false),
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_SELECTED]: (this._descentSpeedSelected && this._descentSpeedSelected.isValid() ? this._descentSpeedSelected.speed : false),
	            //[SpeedType.SPEED_TYPE_WAYPOINT]: (this._waypointSpeedConstraint && this._waypointSpeedConstraint.isValid() ? this._waypointSpeedConstraint.speed : false),
	            [HDSpeedType_1.HDSpeedType.SPEED_TYPE_ECON]: (this._descentSpeedEcon && this._descentSpeedEcon.isValid() ? this._descentSpeedEcon.speed : false)
	        };
	        this._updateLastCommandedSpeed();
	        this._updateLastMachMode();
	        let commandedSpeedKey = Object.keys(speed).filter(key => !!speed[key]).reduce((accumulator, value) => {
	        ...
	        this._updateCommandedSpeed(commandedSpeedKey, HDSpeedPhase_1.HDSpeedPhase.SPEED_PHASE_DESCENT);
	        this._updateMachMode();
	    }
	    _updateApproachSpeed() {
	        ...
	        commandedSpeedKey = this.shouldCommandSelectedSpeed(commandedSpeedKey, this._descentSpeedSelected);
	        this._updateCommandedSpeed(commandedSpeedKey, HDSpeedPhase_1.HDSpeedPhase.SPEED_PHASE_APPROACH);
	        this._updateMachMode();
	    }
	...
	SpeedDirector$1.SpeedDirector = SpeedDirector;
	...
	(function (HeavyDivision) {
	    class Configuration {
	        static activeFlightPlanSynchronizationStrategy() {
	            return parseInt(HeavyDataStorage_1.HeavyDataStorage.get('FP_SYNCHRONIZATION_STRATEGY', '0'));
	        }
	        ...
	        static isFocusableScratchpadEnabled() {
	            return (!!parseInt(HeavyDataStorage_1.HeavyDataStorage.get('IS_FOCUSABLE_SCRATCHPAD_ENABLED', 0)));
	        }
	        static useImperial() {
	            return (!!parseInt(HeavyDataStorage_1.HeavyDataStorage.get('USE_IMPERIAL', 1)));
	        }
	        static useMetric() {
	    ...
	    class SimBrief {
	        static importRouteOnly() {
	            return (!!parseInt(HeavyDataStorage_1.HeavyDataStorage.get('SIMBRIEF_ROUTE_ONLY', 0)));
	        }
	        static importSid() {
	            return (!!parseInt(HeavyDataStorage_1.HeavyDataStorage.get('SIMBRIEF_WITH_SID', 0)));
	        }
	        static importStar() {
	            return (!!parseInt(HeavyDataStorage_1.HeavyDataStorage.get('SIMBRIEF_WITH_STAR', 0)));
	        }
	        static importStrategy() {
	            return HeavyDataStorage_1.HeavyDataStorage.get('SIMBRIEF_IMPORT_STRATEGY', 'INGAME');
	        }
	    }
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	__exportStar(SimBrief$1, exports);
	__exportStar(SimBriefCredentials$1, exports);
	__exportStar(SimBriefApi$1, exports);
	__exportStar(SimBriefOceanicWaypointConverter$1, exports);
	__exportStar(SimBriefNavlogParser$1, exports);
	__exportStar(SimBriefImporter$1, exports);
	__exportStar(HeavyDataStorage$1, exports);
	__exportStar(HeavyInput$1, exports);
	__exportStar(FMCRendererModule, exports);
	__exportStar(SpeedDirector$1, exports);
	__exportStar(HDSpeedType, exports);
	__exportStar(HDSpeedPhase, exports);
	__exportStar(HeavyDivision, exports);
	}(hdsdk));

	Object.defineProperty(BaseFMC$1, "__esModule", { value: true });
	BaseFMC$1.BaseFMC = void 0;
	const SpeedRepository_1 = SpeedRepository$1;
	const SpeedManager_1 = SpeedManager$1;
	const SpeedCalculator_1 = SpeedCalculator$1;
	const hdlogger_1$6 = hdlogger;
	const level_1$6 = level;
	const HDSDK$e = hdsdk;
	class BaseFMC extends BaseAirliners {
	    ...
	    Init() {
	        ...
	        this._speedRepository = new SpeedRepository_1.SpeedRepository();
	        this._speedManager = new SpeedManager_1.SpeedManager(this._speedRepository, new SpeedCalculator_1.SpeedCalculator());
	        ...
	        this.flightPlanManager.onCurrentGameFlightLoaded(() => {
	            this.flightPlanManager.updateFlightPlan(() => {
	                ...
	                let callback = () => {
	                    ...
	                    hdlogger_1$6.HDLogger.log('FlightPlan Cruise Override. Cruising at FL' + cruiseAlt + ' instead of default FL' + this.cruiseFlightLevel, level_1$6.Level.info);
	                    if (cruiseAlt > 0) {
	        ...
	        if (this.urlConfig.index === 1) {
	            if (HDSDK$e.HeavyDivision.Configuration.isFocusableScratchpadEnabled()) {
	    ...
	    onApproachUpdated() {
	        ...
	        if (isFinite(frequency)) {
	            ...
	            if (approach && approach.name && approach.name.indexOf('ILS') != -1) {
	                ...
	                hdlogger_1$6.HDLogger.log('FMCMainDisplay - Frequency is a VOR FREQUENCY', level_1$6.Level.debug);
	                this.vor1Frequency = freq;
	            }
	    ...
	    onEvent(_event) {
	        if (_event.indexOf('1_BTN_') !== -1 || _event.indexOf('BTN_') !== -1) {
	            ...
	            if (input === 'INIT') {
	                ...
	                hdlogger_1$6.HDLogger.log('\'' + input + '\'', level_1$6.Level.debug);
	            }
	        }
	    }
	    clearDisplay() {
	    ...
	    setAPSpeedHoldMode() {
	        if (!Simplane.getAutoPilotMachModeActive()) {
	            if (!SimVar.GetSimVarValue('AUTOPILOT AIRSPEED HOLD', 'Boolean')) {
	                ...
	                hdlogger_1$6.HDLogger.log('Activating SPEED HOLD (Knots)', level_1$6.Level.debug);
	            }
	        }
	        else {
	            if (!SimVar.GetSimVarValue('AUTOPILOT MACH HOLD', 'Boolean')) {
	                ...
	                hdlogger_1$6.HDLogger.log('Activating SPEED HOLD (Mach)', level_1$6.Level.debug);
	            }
	        }
	    }
	}
	BaseFMC$1.BaseFMC = BaseFMC;
	...
	var PreFlightDataHolder$1 = {};

	Object.defineProperty(PreFlightDataHolder$1, "__esModule", { value: true });
	PreFlightDataHolder$1.RoutePagePreFlightCheck = PreFlightDataHolder$1.PerfInitPagePreFlightCheck = PreFlightDataHolder$1.TakeOffPagePreFlightCheck = PreFlightDataHolder$1.ThrustLimPagePreFlightCheck = PreFlightDataHolder$1.PreFlightDataHolder = void 0;
	...
	PreFlightDataHolder$1.PreFlightDataHolder = PreFlightDataHolder;
	...
	PreFlightDataHolder$1.ThrustLimPagePreFlightCheck = ThrustLimPagePreFlightCheck;
	...
	PreFlightDataHolder$1.TakeOffPagePreFlightCheck = TakeOffPagePreFlightCheck;
	...
	PreFlightDataHolder$1.PerfInitPagePreFlightCheck = PerfInitPagePreFlightCheck;
	...
	PreFlightDataHolder$1.RoutePagePreFlightCheck = RoutePagePreFlightCheck;

	Object.defineProperty(FMCDataHolder$1, "__esModule", { value: true });
	FMCDataHolder$1.FMCDataHolder = void 0;
	const PreFlightDataHolder_1 = PreFlightDataHolder$1;
	class FMCDataHolder {
	    get preFlightDataHolder() {
	        return this._preFlightDataHolder;
	    }
	    constructor() {
	        this._preFlightDataHolder = new PreFlightDataHolder_1.PreFlightDataHolder();
	    }
	}
	FMCDataHolder$1.FMCDataHolder = FMCDataHolder;

	Object.defineProperty(Boeing_FMC$1, "__esModule", { value: true });
	Boeing_FMC$1.Boeing_FMC = void 0;
	const BaseFMC_1$5 = BaseFMC$1;
	const HDSDK$d = hdsdk;
	const hdlogger_1$5 = hdlogger;
	const level_1$5 = level;
	const FMCDataHolder_1 = FMCDataHolder$1;
	class Boeing_FMC extends BaseFMC_1$5.BaseFMC {
	    setTakeOffFlap(s) {
	        let value = Number.parseInt(s);
	        if (isFinite(value)) {
	            /**
	    ...
	    constructor() {
	        ...
	        this.dataHolder = new FMCDataHolder_1.FMCDataHolder();
	    ...
	    onEvent(_event) {
	        ...
	        hdlogger_1$5.HDLogger.log('B787_10_BaseFMC onEvent ' + _event, level_1$5.Level.debug);
	    ...
	    recalculateTHRRedAccTransAlt() {
	        ...
	        if (this._speedDirector === undefined) {
	            this._speedDirector = new HDSDK$d.SpeedDirector(this.speedManager);
	        }
	        let origin = this.flightPlanManager.getOrigin();
	        if (origin) {
	...
	Boeing_FMC$1.Boeing_FMC = Boeing_FMC;
	BaseFMC_1$5.BaseFMC.clrValue = 'DELETE';

	var B787_10_FMC_InitRefIndexPage$1 = {};

	var B787_10_FMC_IdentPage$1 = {};

	var B787_10_FMC_PosInitPage$1 = {};

	var B787_10_FMC_RoutePage$1 = {};

	var B787_10_FMC_RouteRequestPage$1 = {};

	var RemoveTocParserMiddleware$1 = {};

	Object.defineProperty(RemoveTocParserMiddleware$1, "__esModule", { value: true });
	RemoveTocParserMiddleware$1.RemoveTocParserMiddleware = void 0;
	...
	RemoveTocParserMiddleware$1.RemoveTocParserMiddleware = RemoveTocParserMiddleware;

	var RemoveTodParserMiddleware$1 = {};

	Object.defineProperty(RemoveTodParserMiddleware$1, "__esModule", { value: true });
	RemoveTodParserMiddleware$1.RemoveTodParserMiddleware = void 0;
	...
	RemoveTodParserMiddleware$1.RemoveTodParserMiddleware = RemoveTodParserMiddleware;

	var RemoveOriginParserMiddleware$1 = {};

	Object.defineProperty(RemoveOriginParserMiddleware$1, "__esModule", { value: true });
	RemoveOriginParserMiddleware$1.RemoveOriginParserMiddleware = void 0;
	...
	RemoveOriginParserMiddleware$1.RemoveOriginParserMiddleware = RemoveOriginParserMiddleware;

	var RemoveDestinationParserMiddleware$1 = {};

	Object.defineProperty(RemoveDestinationParserMiddleware$1, "__esModule", { value: true });
	RemoveDestinationParserMiddleware$1.RemoveDestinationParserMiddleware = void 0;
	...
	RemoveDestinationParserMiddleware$1.RemoveDestinationParserMiddleware = RemoveDestinationParserMiddleware;

	var RemoveSidParserMiddleware$1 = {};

	Object.defineProperty(RemoveSidParserMiddleware$1, "__esModule", { value: true });
	RemoveSidParserMiddleware$1.RemoveSidParserMiddleware = void 0;
	/**
	 * TODO:
	 *
	...
	RemoveSidParserMiddleware$1.RemoveSidParserMiddleware = RemoveSidParserMiddleware;

	var RemoveStarParserMiddleware$1 = {};

	Object.defineProperty(RemoveStarParserMiddleware$1, "__esModule", { value: true });
	RemoveStarParserMiddleware$1.RemoveStarParserMiddleware = void 0;
	/**
	 * TODO:
	 *
	...
	RemoveStarParserMiddleware$1.RemoveStarParserMiddleware = RemoveStarParserMiddleware;

	var BreakNatsParserMiddleware$1 = {};

	Object.defineProperty(BreakNatsParserMiddleware$1, "__esModule", { value: true });
	BreakNatsParserMiddleware$1.BreakNatsParserMiddleware = void 0;
	...
	BreakNatsParserMiddleware$1.BreakNatsParserMiddleware = BreakNatsParserMiddleware;

	var HDNavlog$1 = {};

	Object.defineProperty(HDNavlog$1, "__esModule", { value: true });
	HDNavlog$1.HDNavlog = void 0;
	const hdlogger_1$4 = hdlogger;
	const level_1$4 = level;
	class HDNavlog {
	    constructor(fmc) {
	    ...
	    async setToGameIngame(configuration) {
	        ...
	        await Promise.all([
	            ...
	            hdlogger_1$4.HDLogger.log('INITIAL DATA SET');
	        }).catch((error) => {
	            hdlogger_1$4.HDLogger.log(error, level_1$4.Level.fatal);
	        });
	        ...
	        if (this.isSimBriefRouteValidIngame(this.fixes)) {
	            hdlogger_1$4.HDLogger.log('SB Route is valid ingame route: USING SB import strategy', level_1$4.Level.debug);
	            await this.insertWaypoints(this.fixes);
	        }
	        else {
	            hdlogger_1$4.HDLogger.log('SB Route is NOT valid ingame route: CHECKING errors', level_1$4.Level.debug);
	            const errors = this.getProblemsOfRoute(this.fixes);
	            this.fixRoute(errors, this.fixes);
	            if (this.isSimBriefRouteValidIngame(this.fixes)) {
	                hdlogger_1$4.HDLogger.log('SB Route is fixed and the route is valid ingame route now: USING SB import strategy', level_1$4.Level.debug);
	                await this.insertWaypoints(this.fixes);
	            }
	            else {
	                hdlogger_1$4.HDLogger.log('SB Route is NOT valid after fixes', level_1$4.Level.error);
	            }
	        }
	    }
	    fixRoute(errors, fixes) {
	        for (const error of errors) {
	            hdlogger_1$4.HDLogger.log('APPLYING FIX TO: ' + error.fix.ident + '; FIX TYPE: ' + error.apply, level_1$4.Level.info);
	    ...
	    async airportDump() {
	        ...
	        houston.infos.departures.forEach((departure) => {
	            ...
	            /**
	             * All EnRoute TRANS (Does not emscripten default one: RITAA6 -> RITAA is not in the list)
	             */
	        ...
	        houston.infos.arrivals.forEach((arrival) => {
	            ...
	            /**
	             * All EnRoute TRANS (Does not emscripten default one: same as departure)
	             */
	    ...
	    async insertWaypoints(fixes) {
	        return new Promise(async (resolve, reject) => {
	            ...
	            for (const fix of fixes) {
	                ...
	                hdlogger_1$4.HDLogger.log(fix.ident + ' ADDING TO FP', level_1$4.Level.debug);
	                this.fmc.flightPlanManager.pauseSync();
	                await this.insertWaypoint(fix, idx);
	                this.fmc.flightPlanManager.resumeSync();
	                hdlogger_1$4.HDLogger.log(fix.ident + ' ADDED TO FP', level_1$4.Level.info);
	                iterator++;
	            }
	    ...
	    async setPayload(weights) {
	        ...
	        hdlogger_1$4.HDLogger.log('SETTING ZFW to: ' + (emptyWeight + payload), level_1$4.Level.debug);
	        hdlogger_1$4.HDLogger.log('PAYLOAD : ' + (payload), level_1$4.Level.debug);
	        hdlogger_1$4.HDLogger.log('ZFW: ' + (emptyWeight), level_1$4.Level.debug);
	    ...
	    async setFuel(fuel) {
	        ...
	        let rightToSet = 0;
	        let centerToSet = 0;
	        hdlogger_1$4.HDLogger.log('BLOCK TO SET: ' + block, level_1$4.Level.debug);
	        hdlogger_1$4.HDLogger.log('RESERVES TO SET: ' + reserve, level_1$4.Level.debug);
	        hdlogger_1$4.HDLogger.log('NEED CENTER TANK: ' + needCenterTank, level_1$4.Level.debug);
	        if (!needCenterTank) {
	        ...
	        hdlogger_1$4.HDLogger.log('CENTER TO SET: ' + centerToSet, level_1$4.Level.debug);
	        hdlogger_1$4.HDLogger.log('LEFT TO SET: ' + leftToSet, level_1$4.Level.debug);
	        hdlogger_1$4.HDLogger.log('RIGHT TO SET: ' + rightToSet, level_1$4.Level.debug);
	        SimVar.SetSimVarValue('FUEL TANK CENTER QUANTITY', 'Gallons', centerToSet / poundsPerGallonCoefficient).catch(() => {
	            hdlogger_1$4.HDLogger.log('SETTING OF FUEL TANK CENTER QUANTITY FAILED', level_1$4.Level.error);
	        });
	        SimVar.SetSimVarValue('FUEL TANK LEFT MAIN QUANTITY', 'Gallons', leftToSet / poundsPerGallonCoefficient).catch(() => {
	            hdlogger_1$4.HDLogger.log('SETTING OF FUEL TANK LEFT QUANTITY FAILED', level_1$4.Level.error);
	        });
	        SimVar.SetSimVarValue('FUEL TANK RIGHT MAIN QUANTITY', 'Gallons', rightToSet / poundsPerGallonCoefficient).catch(() => {
	            hdlogger_1$4.HDLogger.log('SETTING OF FUEL TANK RIGHT QUANTITY FAILED', level_1$4.Level.error);
	        });
	    ...
	    setInitialCruiseAltitude(cruiseAltitude) {
	        ...
	        hdlogger_1$4.HDLogger.log('Setting CruiseAltitude to: ' + cruiseAltitude, level_1$4.Level.debug);
	        return SimVar.SetSimVarValue('L:AIRLINER_CRUISE_ALTITUDE', 'number', cruiseAltitude)
	            ...
	            hdlogger_1$4.HDLogger.log('cruiseFlightLevel set to: ' + cruiseFlightLevel, level_1$4.Level.debug);
	            hdlogger_1$4.HDLogger.log('CruiseAltitude set to: ' + cruiseAltitude, level_1$4.Level.debug);
	            return true;
	        }).catch((error) => {
	            hdlogger_1$4.HDLogger.log('Unable to set cruise altitude to LVAR');
	            return false;
	        });
	    }
	    /**
	    ...
	    async setOrigin(icao) {
	        ...
	        if (!airport) {
	            hdlogger_1$4.HDLogger.log('ORIGIN NOT IN DATABASE: ' + icao, level_1$4.Level.warning);
	            this.fmc.showErrorMessage('NOT IN DATABASE');
	    ...
	    async setDestination(icao) {
	        ...
	        const airport = await this.fmc.dataManager.GetAirportByIdent(icao);
	        if (!airport) {
	            hdlogger_1$4.HDLogger.log('DESTINATION NOT IN DATABASE: ' + icao, level_1$4.Level.warning);
	            this.fmc.showErrorMessage('NOT IN DATABASE');
	    ...
	    asyncSetCostIndex(costIndex) {
	        return new Promise(((resolve) => {
	            if (this.fmc.tryUpdateCostIndex(costIndex, 10000)) {
	                hdlogger_1$4.HDLogger.log('CostIndex has been set to: ' + costIndex, level_1$4.Level.debug);
	                resolve(true);
	            }
	            else {
	                hdlogger_1$4.HDLogger.log('CostIndex could not be updated (invalid value): ' + costIndex + '; CI RANGE 0 - 9999', level_1$4.Level.warning);
	                resolve(false);
	            }
	        }));
	    }
	    asyncSetOrigin(airport) {
	        return new Promise((resolve) => {
	            this.fmc.flightPlanManager.setOrigin(airport.icao, () => {
	                ...
	                hdlogger_1$4.HDLogger.log('ORIGIN set to: ' + airport.icao, level_1$4.Level.debug);
	    ...
	    asyncSetDestination(airport) {
	        return new Promise((resolve) => {
	            this.fmc.flightPlanManager.setDestination(airport.icao, () => {
	                ...
	                hdlogger_1$4.HDLogger.log('DESTINATION set to: ' + airport.icao, level_1$4.Level.debug);
	...
	HDNavlog$1.HDNavlog = HDNavlog;

	var B787_10_FMC_SelectWptPage$1 = {};

	Object.defineProperty(B787_10_FMC_SelectWptPage$1, "__esModule", { value: true });
	B787_10_FMC_SelectWptPage$1.B787_10_FMC_SelectWptPage = void 0;
	...
	B787_10_FMC_SelectWptPage$1.B787_10_FMC_SelectWptPage = B787_10_FMC_SelectWptPage;

	Object.defineProperty(B787_10_FMC_RouteRequestPage$1, "__esModule", { value: true });
	B787_10_FMC_RouteRequestPage$1.B787_10_FMC_RouteRequestPage = void 0;
	const B787_10_FMC_RoutePage_1$3 = B787_10_FMC_RoutePage$1;
	const HDSDK$c = hdsdk;
	const RemoveTocParserMiddleware_1 = RemoveTocParserMiddleware$1;
	const RemoveTodParserMiddleware_1 = RemoveTodParserMiddleware$1;
	const RemoveOriginParserMiddleware_1 = RemoveOriginParserMiddleware$1;
	const RemoveDestinationParserMiddleware_1 = RemoveDestinationParserMiddleware$1;
	const RemoveSidParserMiddleware_1 = RemoveSidParserMiddleware$1;
	const RemoveStarParserMiddleware_1 = RemoveStarParserMiddleware$1;
	const BreakNatsParserMiddleware_1 = BreakNatsParserMiddleware$1;
	const HDNavlog_1 = HDNavlog$1;
	const hdlogger_1$3 = hdlogger;
	const level_1$3 = level;
	const B787_10_FMC_SelectWptPage_1$1 = B787_10_FMC_SelectWptPage$1;
	class B787_10_FMC_RouteRequestPage {
	    ...
	    parseAirways(navlog) {
	        ...
	        for (let i = 0; i < navlog.length; i++) {
	            let ident = HDSDK$c.SimBriefOceanicWaypointConverter.convert(navlog[i].ident);
	            let airwayIn;
	            let airwayOut;
	            /**
	    ...
	    setupInputHandlers() {
	        this.fmc._renderer.lsk(6).event = () => {
	            ...
	            B787_10_FMC_RoutePage_1$3.B787_10_FMC_RoutePage.ShowPage1(this.fmc);
	        };
	        this.fmc._renderer.lsk(1).event = () => {
	            ...
	            const parser = new HDSDK$c.SimBriefNavlogParser(new HDSDK$c.SimBrief());
	            parser.use(new RemoveTocParserMiddleware_1.RemoveTocParserMiddleware());
	            parser.use(new RemoveTodParserMiddleware_1.RemoveTodParserMiddleware());
	            parser.use(new RemoveOriginParserMiddleware_1.RemoveOriginParserMiddleware());
	            parser.use(new RemoveDestinationParserMiddleware_1.RemoveDestinationParserMiddleware());
	            parser.use(new RemoveSidParserMiddleware_1.RemoveSidParserMiddleware());
	            parser.use(new RemoveStarParserMiddleware_1.RemoveStarParserMiddleware());
	            parser.use(new BreakNatsParserMiddleware_1.BreakNatsParserMiddleware());
	            const importer = new HDSDK$c.SimBriefImporter(parser);
	            const navlog = new HDNavlog_1.HDNavlog(this.fmc);
	            navlog.setImporter(importer);
	            navlog.import().then(() => {
	                const configuration = {
	                    withSid: HDSDK$c.HeavyDivision.SimBrief.importSid(),
	                    withStar: HDSDK$c.HeavyDivision.SimBrief.importStar(),
	                    routeOnly: HDSDK$c.HeavyDivision.SimBrief.importRouteOnly()
	                };
	                if (HDSDK$c.HeavyDivision.SimBrief.importStrategy() === 'INGAME') {
	                ...
	                hdlogger_1$3.HDLogger.log(error, level_1$3.Level.error);
	            });
	        };
	        /**
	        ...
	        this.fmc._renderer.lsk(2).event = () => {
	            ...
	            let parseNavlog = () => {
	                ...
	                navlog.forEach((fix) => {
	                    let ident = HDSDK$c.SimBriefOceanicWaypointConverter.convert(fix.ident);
	                    waypoints.push({
	                        ident: ident,
	    ...
	    getOrSelectWaypointByIdentFast(ident, waypoint, callback) {
	        ...
	        this.fmc.dataManager.GetWaypointsByIdent(ident).then((waypoints) => {
	            ...
	            B787_10_FMC_SelectWptPage_1$1.B787_10_FMC_SelectWptPage.ShowPage(this.fmc, waypoints, callback);
	        });
	    }
	...
	B787_10_FMC_RouteRequestPage$1.B787_10_FMC_RouteRequestPage = B787_10_FMC_RouteRequestPage;

	var B787_10_FMC_PerfInitPage$1 = {};

	var B787_10_FMC_ThrustLimPage$1 = {};

	var B787_10_FMC_TakeOffRefPage$1 = {};

	Object.defineProperty(B787_10_FMC_TakeOffRefPage$1, "__esModule", { value: true });
	B787_10_FMC_TakeOffRefPage$1.B787_10_FMC_TakeOffRefPage = void 0;
	const B787_10_FMC_InitRefIndexPage_1$7 = B787_10_FMC_InitRefIndexPage$1;
	const B787_10_FMC_ThrustLimPage_1$3 = B787_10_FMC_ThrustLimPage$1;
	const BaseFMC_1$4 = BaseFMC$1;
	const HDSDK$b = hdsdk;
	class B787_10_FMC_TakeOffRefPage {
	    static ShowPage1(fmc) {
	        ...
	        fmc._renderer.rsk(1).event = () => {
	            let value = fmc.inOut;
	            fmc.clearUserInput();
	            if (value === BaseFMC_1$4.BaseFMC.clrValue) {
	        ...
	        const useImperial = HDSDK$b.HeavyDivision.Configuration.useImperial();
	        let grWtCell = '□□□.□';
	        ...
	        fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_InitRefIndexPage_1$7.B787_10_FMC_InitRefIndexPage.ShowPage1(fmc);
	        };
	        fmc._renderer.rsk(6).event = () => {
	            B787_10_FMC_ThrustLimPage_1$3.B787_10_FMC_ThrustLimPage.ShowPage1(fmc);
	        };
	        fmc.onPrevPage = () => {
	...
	B787_10_FMC_TakeOffRefPage$1.B787_10_FMC_TakeOffRefPage = B787_10_FMC_TakeOffRefPage;
	B787_10_FMC_TakeOffRefPage._timer = 0;

	Object.defineProperty(B787_10_FMC_ThrustLimPage$1, "__esModule", { value: true });
	B787_10_FMC_ThrustLimPage$1.B787_10_FMC_ThrustLimPage = void 0;
	const B787_10_FMC_InitRefIndexPage_1$6 = B787_10_FMC_InitRefIndexPage$1;
	const B787_10_FMC_TakeOffRefPage_1$1 = B787_10_FMC_TakeOffRefPage$1;
	class B787_10_FMC_ThrustLimPage {
	    static ShowPage1(fmc) {
	        ...
	        fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_InitRefIndexPage_1$6.B787_10_FMC_InitRefIndexPage.ShowPage1(fmc);
	        };
	        fmc._renderer.rsk(6).event = () => {
	            B787_10_FMC_TakeOffRefPage_1$1.B787_10_FMC_TakeOffRefPage.ShowPage1(fmc);
	        };
	    }
	}
	B787_10_FMC_ThrustLimPage$1.B787_10_FMC_ThrustLimPage = B787_10_FMC_ThrustLimPage;
	B787_10_FMC_ThrustLimPage._updateCounter = 0;

	Object.defineProperty(B787_10_FMC_PerfInitPage$1, "__esModule", { value: true });
	B787_10_FMC_PerfInitPage$1.B787_10_FMC_PerfInitPage = void 0;
	const B787_10_FMC_InitRefIndexPage_1$5 = B787_10_FMC_InitRefIndexPage$1;
	const B787_10_FMC_ThrustLimPage_1$2 = B787_10_FMC_ThrustLimPage$1;
	const HDSDK$a = hdsdk;
	class B787_10_FMC_PerfInitPage {
	    static ShowPage1(fmc) {
	        fmc.updateFuelVars().then(() => {
	            fmc.cleanUpPage();
	            const useImperial = HDSDK$a.HeavyDivision.Configuration.useImperial();
	            ...
	            fmc._renderer.lsk(6).event = () => {
	                B787_10_FMC_InitRefIndexPage_1$5.B787_10_FMC_InitRefIndexPage.ShowPage1(fmc);
	            };
	            fmc._renderer.rsk(6).event = () => {
	                B787_10_FMC_ThrustLimPage_1$2.B787_10_FMC_ThrustLimPage.ShowPage1(fmc);
	            };
	        });
	    }
	}
	B787_10_FMC_PerfInitPage$1.B787_10_FMC_PerfInitPage = B787_10_FMC_PerfInitPage;
	B787_10_FMC_PerfInitPage._timer = 0;

	Object.defineProperty(B787_10_FMC_RoutePage$1, "__esModule", { value: true });
	B787_10_FMC_RoutePage$1.B787_10_FMC_RoutePage = void 0;
	// prototype singleton, this needs to be different ofc
	const B787_10_FMC_RouteRequestPage_1 = B787_10_FMC_RouteRequestPage$1;
	const B787_10_FMC_PerfInitPage_1$2 = B787_10_FMC_PerfInitPage$1;
	const BaseFMC_1$3 = BaseFMC$1;
	const HDSDK$9 = hdsdk;
	...
	class B787_10_FMC_RoutePage {
	    ...
	    bindEvents() {
	        if (this._currentPage == 0) {
	            ...
	            if (HDSDK$9.HeavyDataStorage.get('SIMBRIEF_USERNAME') || HDSDK$9.HeavyDataStorage.get('SIMBRIEF_USERID')) {
	                this._fmc._renderer.lsk(3).event = () => {
	                    new B787_10_FMC_RouteRequestPage_1.B787_10_FMC_RouteRequestPage(this._fmc).showPage();
	                };
	            }
	        }
	        else {
	        ...
	        this._fmc._renderer.rsk(6).event = () => {
	            if (this._activateCell === 'PERF INIT>') {
	                B787_10_FMC_PerfInitPage_1$2.B787_10_FMC_PerfInitPage.ShowPage1(this._fmc);
	            }
	    ...
	    bindRowEvents(lskIdx) {
	        ...
	        this._fmc._renderer.rsk(lskIdx + 1).event = () => {
	            ...
	            if (value === BaseFMC_1$3.BaseFMC.clrValue) {
	                this._fmc.clearUserInput();
	                if (row.isDeparture) {
	                    this._fmc.ensureCurrentFlightPlanIsTemporary(() => {
	...
	B787_10_FMC_RoutePage$1.B787_10_FMC_RoutePage = B787_10_FMC_RoutePage;
	class FpRow {
	...
	Object.defineProperty(B787_10_FMC_PosInitPage$1, "__esModule", { value: true });
	B787_10_FMC_PosInitPage$1.B787_10_FMC_PosInitPage = void 0;
	const B787_10_FMC_InitRefIndexPage_1$4 = B787_10_FMC_InitRefIndexPage$1;
	const B787_10_FMC_RoutePage_1$2 = B787_10_FMC_RoutePage$1;
	class B787_10_FMC_PosInitPage {
	    static ShowPage1(fmc) {
	        ...
	        fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_InitRefIndexPage_1$4.B787_10_FMC_InitRefIndexPage.ShowPage1(fmc);
	        };
	        fmc._renderer.rsk(6).event = () => {
	            B787_10_FMC_RoutePage_1$2.B787_10_FMC_RoutePage.ShowPage1(fmc);
	        };
	        fmc.onPrevPage = () => {
	...
	B787_10_FMC_PosInitPage$1.B787_10_FMC_PosInitPage = B787_10_FMC_PosInitPage;

	Object.defineProperty(B787_10_FMC_IdentPage$1, "__esModule", { value: true });
	B787_10_FMC_IdentPage$1.B787_10_FMC_IdentPage = void 0;
	const B787_10_FMC_InitRefIndexPage_1$3 = B787_10_FMC_InitRefIndexPage$1;
	const B787_10_FMC_PosInitPage_1$1 = B787_10_FMC_PosInitPage$1;
	class B787_10_FMC_IdentPage {
	    static ShowPage1(fmc) {
	        ...
	        if (fmc.urlConfig.index == 1) {
	            fmc._renderer.lsk(6).event = () => {
	                B787_10_FMC_InitRefIndexPage_1$3.B787_10_FMC_InitRefIndexPage.ShowPage1(fmc);
	            };
	            fmc._renderer.rsk(6).event = () => {
	                B787_10_FMC_PosInitPage_1$1.B787_10_FMC_PosInitPage.ShowPage1(fmc);
	            };
	        }
	        /**
	...
	B787_10_FMC_IdentPage$1.B787_10_FMC_IdentPage = B787_10_FMC_IdentPage;
	B787_10_FMC_IdentPage._updateCounter = 0;

	var B787_10_FMC_ApproachPage$1 = {};

	Object.defineProperty(B787_10_FMC_ApproachPage$1, "__esModule", { value: true });
	B787_10_FMC_ApproachPage$1.B787_10_FMC_ApproachPage = void 0;
	const B787_10_FMC_InitRefIndexPage_1$2 = B787_10_FMC_InitRefIndexPage$1;
	const B787_10_FMC_ThrustLimPage_1$1 = B787_10_FMC_ThrustLimPage$1;
	const HDSDK$8 = hdsdk;
	class B787_10_FMC_ApproachPage {
	    static ShowPage1(fmc) {
	        ...
	        let flaps25VRefCell = '';
	        let flaps30VRefCell = '';
	        const useImperial = HDSDK$8.HeavyDivision.Configuration.useImperial();
	        ...
	        fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_InitRefIndexPage_1$2.B787_10_FMC_InitRefIndexPage.ShowPage1(fmc);
	        };
	        fmc._renderer.rsk(6).event = () => {
	            B787_10_FMC_ThrustLimPage_1$1.B787_10_FMC_ThrustLimPage.ShowPage1(fmc);
	        };
	    }
	}
	B787_10_FMC_ApproachPage$1.B787_10_FMC_ApproachPage = B787_10_FMC_ApproachPage;

	var B787_10_FMC_MaintPage$1 = {};

	Object.defineProperty(B787_10_FMC_MaintPage$1, "__esModule", { value: true });
	B787_10_FMC_MaintPage$1.B787_10_FMC_MaintPage = void 0;
	const B787_10_FMC_InitRefIndexPage_1$1 = B787_10_FMC_InitRefIndexPage$1;
	class B787_10_FMC_MaintPage {
	    static ShowPage1(fmc) {
	        ...
	        fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_InitRefIndexPage_1$1.B787_10_FMC_InitRefIndexPage.ShowPage1(fmc);
	        };
	    }
	}
	B787_10_FMC_MaintPage$1.B787_10_FMC_MaintPage = B787_10_FMC_MaintPage;

	Object.defineProperty(B787_10_FMC_InitRefIndexPage$1, "__esModule", { value: true });
	B787_10_FMC_InitRefIndexPage$1.B787_10_FMC_InitRefIndexPage = void 0;
	const B787_10_FMC_IdentPage_1$1 = B787_10_FMC_IdentPage$1;
	const B787_10_FMC_ApproachPage_1 = B787_10_FMC_ApproachPage$1;
	const B787_10_FMC_PosInitPage_1 = B787_10_FMC_PosInitPage$1;
	const B787_10_FMC_MaintPage_1 = B787_10_FMC_MaintPage$1;
	const B787_10_FMC_ThrustLimPage_1 = B787_10_FMC_ThrustLimPage$1;
	const B787_10_FMC_TakeOffRefPage_1 = B787_10_FMC_TakeOffRefPage$1;
	const B787_10_FMC_PerfInitPage_1$1 = B787_10_FMC_PerfInitPage$1;
	class B787_10_FMC_InitRefIndexPage {
	    static ShowPage1(fmc) {
	        ...
	        fmc._renderer.lsk(1).event = () => {
	            B787_10_FMC_IdentPage_1$1.B787_10_FMC_IdentPage.ShowPage1(fmc);
	        };
	        fmc._renderer.lsk(2).event = () => {
	            B787_10_FMC_PosInitPage_1.B787_10_FMC_PosInitPage.ShowPage1(fmc);
	        };
	        fmc._renderer.lsk(3).event = () => {
	            B787_10_FMC_PerfInitPage_1$1.B787_10_FMC_PerfInitPage.ShowPage1(fmc);
	        };
	        fmc._renderer.lsk(4).event = () => {
	            B787_10_FMC_ThrustLimPage_1.B787_10_FMC_ThrustLimPage.ShowPage1(fmc);
	        };
	        fmc._renderer.lsk(5).event = () => {
	            B787_10_FMC_TakeOffRefPage_1.B787_10_FMC_TakeOffRefPage.ShowPage1(fmc);
	        };
	        fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_ApproachPage_1.B787_10_FMC_ApproachPage.ShowPage1(fmc);
	        };
	        fmc._renderer.rsk(6).event = () => {
	            B787_10_FMC_MaintPage_1.B787_10_FMC_MaintPage.ShowPage1(fmc);
	        };
	    }
	}
	B787_10_FMC_InitRefIndexPage$1.B787_10_FMC_InitRefIndexPage = B787_10_FMC_InitRefIndexPage;

	var B787_10_FMC_LegsPage$1 = {};

	var B787_10_FMC_HoldsPage$1 = {};

	Object.defineProperty(B787_10_FMC_HoldsPage$1, "__esModule", { value: true });
	B787_10_FMC_HoldsPage$1.B787_10_FMC_HoldsPage = void 0;
	const B787_10_FMC_LegsPage_1$2 = B787_10_FMC_LegsPage$1;
	class B787_10_FMC_HoldsPage {
	    ...
	    update(forceUpdate = false) {
	        ...
	        if (currentHolds.length === 0) {
	            B787_10_FMC_LegsPage_1$2.B787_10_FMC_LegsPage.ShowPage1(this._fmc, true);
	        }
	        else {
	    ...
	    bindFplnHoldInputs(currentHold, numHolds) {
	        ...
	        if (numHolds < 6) {
	            this._fmc._renderer.rsk(5).event = () => B787_10_FMC_LegsPage_1$2.B787_10_FMC_LegsPage.ShowPage1(this._fmc, true);
	        }
	    ...
	    bindHoldListInputs(currentHolds) {
	        ...
	        if (currentHolds.length < 6) {
	            this._fmc._renderer.rsk(6).event = () => B787_10_FMC_LegsPage_1$2.B787_10_FMC_LegsPage.ShowPage1(this._fmc, true);
	        }
	    }
	    /**
	    ...
	    static handleHoldPressed(fmc) {
	        const holds = B787_10_FMC_HoldsPage.getFlightplanHolds(fmc);
	        if (holds.length === 0) {
	            B787_10_FMC_LegsPage_1$2.B787_10_FMC_LegsPage.ShowPage1(fmc, true);
	        }
	...
	B787_10_FMC_HoldsPage$1.B787_10_FMC_HoldsPage = B787_10_FMC_HoldsPage;
	...
	var B787_10_FMC_RouteDataPage$1 = {};

	Object.defineProperty(B787_10_FMC_RouteDataPage$1, "__esModule", { value: true });
	B787_10_FMC_RouteDataPage$1.B787_10_FMC_RouteDataPage = void 0;
	const B787_10_FMC_LegsPage_1$1 = B787_10_FMC_LegsPage$1;
	const HDSDK$7 = hdsdk;
	class B787_10_FMC_RouteDataPage {
	    ...
	    showPage(currentPage = 1) {
	        ...
	        if (flightPlanManagerWaypoints) {
	            let useImperial = HDSDK$7.HeavyDivision.Configuration.useImperial();
	            let fuelModifier;
	            if (useImperial) {
	                fuelModifier = 1.0;
	            }
	        ...
	        this.fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_LegsPage_1$1.B787_10_FMC_LegsPage.ShowPage1(this.fmc);
	        };
	        this.fmc.onPrevPage = () => {
	            if (currentPage > 1) {
	...
	B787_10_FMC_RouteDataPage$1.B787_10_FMC_RouteDataPage = B787_10_FMC_RouteDataPage;
	B787_10_FMC_RouteDataPage._updateCounter = 0;

	Object.defineProperty(B787_10_FMC_LegsPage$1, "__esModule", { value: true });
	B787_10_FMC_LegsPage$1.B787_10_FMC_LegsPage = void 0;
	const B787_10_FMC_HoldsPage_1$1 = B787_10_FMC_HoldsPage$1;
	const B787_10_FMC_RouteDataPage_1 = B787_10_FMC_RouteDataPage$1;
	const BaseFMC_1$2 = BaseFMC$1;
	...
	class B787_10_FMC_LegsPage {
	        ...
	        for (let i = 0; i < this._wayPointsToRender.length; i++) {
	            ...
	            if (wptRender && (wptRender.fix.ident !== '$EMPTY' || wptRender.fix.ident !== '$DISCO')) {
	                ...
	                this._fmc._renderer.rsk(i + 1).event = () => {
	                    ...
	                    const value = this._fmc.inOut;
	                    if (value === BaseFMC_1$2.BaseFMC.clrValue) {
	            ...
	            if (wptRender && lsk !== undefined) {
	                lsk.event = async () => {
	                    ...
	                    else if (value === BaseFMC_1$2.BaseFMC.clrValue) {
	    ...
	    bindEvents() {
	        ...
	        if (this._isMapModePlan) {
	            ...
	            this._fmc._renderer.rsk(6).event = () => {
	                new B787_10_FMC_RouteDataPage_1.B787_10_FMC_RouteDataPage(this._fmc).showPage();
	            };
	        }
	    }
	    /**
	    ...
	    addHold() {
	        ...
	        if (holdWaypoint !== undefined) {
	            this._fmc.ensureCurrentFlightPlanIsTemporary(() => {
	                ...
	                this._fmc.inOut = '';
	                this._fmc.activateRoute(false, () => {
	                    B787_10_FMC_HoldsPage_1$1.B787_10_FMC_HoldsPage.showHoldPage(this._fmc, holdWaypoint.waypoint.ident);
	                });
	            });
	        }
	        else {
	...
	B787_10_FMC_LegsPage$1.B787_10_FMC_LegsPage = B787_10_FMC_LegsPage;
	...
	var B787_10_FMC_NavRadioPage$1 = {};

	Object.defineProperty(B787_10_FMC_NavRadioPage$1, "__esModule", { value: true });
	B787_10_FMC_NavRadioPage$1.B787_10_FMC_NavRadioPage = void 0;
	const BaseFMC_1$1 = BaseFMC$1;
	    ...
	    static ShowPage(fmc) {
	        ...
	        if (!radioOn) {
	            ...
	            fmc._renderer.lsk(1).event = () => {
	                ...
	                else if (value === BaseFMC_1$1.BaseFMC.clrValue) {
	                    fmc.vor1Frequency = 0;
	                    B787_10_FMC_NavRadioPage.ShowPage(fmc);
	                }
	                else {
	        ...
	        fmc._renderer.lsk(6).event = () => {
	            let value = fmc.inOut;
	            fmc.clearUserInput();
	            if (value == BaseFMC_1$1.BaseFMC.clrValue) {
	...
	B787_10_FMC_NavRadioPage$1.B787_10_FMC_NavRadioPage = B787_10_FMC_NavRadioPage;
	B787_10_FMC_NavRadioPage._updateCounter = 0;

	var B787_10_FMC_VNAVPage$1 = {};

	Object.defineProperty(B787_10_FMC_VNAVPage$1, "__esModule", { value: true });
	B787_10_FMC_VNAVPage$1.B787_10_FMC_VNAVPage = void 0;
	const HDSDK$6 = hdsdk;
	class B787_10_FMC_VNAVPage {
	    ...
	    getClimbPageTitle() {
	        ...
	        switch (this.fmc._speedDirector.commandedSpeedType) {
	            case HDSDK$6.HDSpeedType.SPEED_TYPE_RESTRICTION:
	    ...
	    getClimbSpeedRestrictionCell() {
	        ...
	        if (speedRestrictionSpeedValue && isFinite(Number(speedRestrictionSpeedValue)) && speedRestrictionAltitudeValue && isFinite(Number(speedRestrictionAltitudeValue))) {
	            if (this.fmc._speedDirector.commandedSpeedType === HDSDK$6.HDSpeedType.SPEED_TYPE_RESTRICTION && this.fmc._speedDirector.speedPhase === HDSDK$6.HDSpeedPhase.SPEED_PHASE_CLIMB && this.fmc.getIsVNAVActive()) {
	    ...
	    getClimbSpeedTransitionCell() {
	        ...
	        if (this.fmc._speedDirector.commandedSpeedType === HDSDK$6.HDSpeedType.SPEED_TYPE_TRANSITION && this.fmc._speedDirector.speedPhase === HDSDK$6.HDSpeedPhase.SPEED_PHASE_CLIMB && this.fmc.getIsVNAVActive()) {
	            cell = this.fmc.colorizeContent(cell, 'magenta');
	        }
	        cell = cell + '/10000';
	        return cell;
	    ...
	    getSelectedClimbSpeedCell() {
	        ...
	        if (this.fmc._speedDirector.commandedSpeedType === HDSDK$6.HDSpeedType.SPEED_TYPE_SELECTED && this.fmc._speedDirector.speedPhase === HDSDK$6.HDSpeedPhase.SPEED_PHASE_CLIMB && this.fmc.getIsVNAVActive()) {
	            cell = this.fmc.colorizeContent(cell, 'magenta');
	        }
	        if (cell) {
	            cell = this.fmc.makeSettable(cell);
	    ...
	    getEconClimbSpeedCell() {
	        ...
	        if (this.fmc._speedDirector.commandedSpeedType === HDSDK$6.HDSpeedType.SPEED_TYPE_ECON && this.fmc._speedDirector.speedPhase === HDSDK$6.HDSpeedPhase.SPEED_PHASE_CLIMB && this.fmc.getIsVNAVActive()) {
	            cell = this.fmc.colorizeContent(cell, 'magenta');
	        }
	        if (cell) {
	            cell = this.fmc.makeSettable(cell);
	    ...
	    getSelectedCruiseSpeedCell() {
	        ...
	        if (this.fmc._speedDirector.commandedSpeedType === HDSDK$6.HDSpeedType.SPEED_TYPE_SELECTED && this.fmc._speedDirector.speedPhase === HDSDK$6.HDSpeedPhase.SPEED_PHASE_CRUISE && this.fmc.getIsVNAVActive()) {
	            cell = this.fmc.colorizeContent(cell, 'magenta');
	        }
	        if (cell) {
	            cell = this.fmc.makeSettable(cell);
	    ...
	    getEconCruiseSpeedCell() {
	        let cell = '';
	        if (this.fmc._speedDirector.commandedSpeedType === HDSDK$6.HDSpeedType.SPEED_TYPE_ECON && this.fmc._speedDirector.speedPhase === HDSDK$6.HDSpeedPhase.SPEED_PHASE_CRUISE && this.fmc.getIsVNAVActive()) {
	            if (Simplane.getAutoPilotMachModeActive()) {
	...
	B787_10_FMC_VNAVPage$1.B787_10_FMC_VNAVPage = B787_10_FMC_VNAVPage;

	var B787_10_FMC_ProgressPage$1 = {};

	Object.defineProperty(B787_10_FMC_ProgressPage$1, "__esModule", { value: true });
	B787_10_FMC_ProgressPage$1.B787_10_FMC_ProgressPage = void 0;
	const HDSDK$5 = hdsdk;
	class B787_10_FMC_ProgressPage {
	    static ShowPage1(fmc) {
	        ...
	        let useImperial = HDSDK$5.HeavyDivision.Configuration.useImperial();
	        let fuelModifier;
	        if (useImperial) {
	            fuelModifier = 1.0;
	        }
	...
	B787_10_FMC_ProgressPage$1.B787_10_FMC_ProgressPage = B787_10_FMC_ProgressPage;
	B787_10_FMC_ProgressPage._timer = 0;

	var B787_10_FMC_FMCCommPage$1 = {};

	Object.defineProperty(B787_10_FMC_FMCCommPage$1, "__esModule", { value: true });
	B787_10_FMC_FMCCommPage$1.B787_10_FMC_FMCCommPage = void 0;
	...
	B787_10_FMC_FMCCommPage$1.B787_10_FMC_FMCCommPage = B787_10_FMC_FMCCommPage;

	var B787_10_FMC_HeavyPage$1 = {};

	var B787_10_FMC_HeavyIRSPage$1 = {};

	Object.defineProperty(B787_10_FMC_HeavyIRSPage$1, "__esModule", { value: true });
	B787_10_FMC_HeavyIRSPage$1.B787_10_FMC_HeavyIRSPage = void 0;
	const B787_10_FMC_HeavyPage_1$3 = B787_10_FMC_HeavyPage$1;
	const HDSDK$4 = hdsdk;
	class B787_10_FMC_HeavyIRSPage {
	    ...
	    showPage() {
	        ...
	        let irsAlignSpeed;
	        switch (HDSDK$4.HeavyDataStorage.get('IRS_ALIGN_SPEED', 'REAL')) {
	            case 'INSTANT':
	        ...
	        this.fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_HeavyPage_1$3.B787_10_FMC_HeavyPage.ShowPage1(this.fmc);
	        };
	    ...
	    showAlignSpeedConfigurationPage() {
	        ...
	        this.fmc._renderer.rsk(2).event = () => {
	            HDSDK$4.HeavyDataStorage.set('IRS_ALIGN_SPEED', 'INSTANT');
	            this.showPage();
	        };
	        this.fmc._renderer.rsk(3).event = () => {
	            HDSDK$4.HeavyDataStorage.set('IRS_ALIGN_SPEED', 'FAST');
	            this.showPage();
	        };
	        this.fmc._renderer.rsk(4).event = () => {
	            HDSDK$4.HeavyDataStorage.set('IRS_ALIGN_SPEED', 'NORMAL');
	            this.showPage();
	        };
	        this.fmc._renderer.rsk(5).event = () => {
	            HDSDK$4.HeavyDataStorage.set('IRS_ALIGN_SPEED', 'REAL');
	            this.showPage();
	        };
	    }
	}
	B787_10_FMC_HeavyIRSPage$1.B787_10_FMC_HeavyIRSPage = B787_10_FMC_HeavyIRSPage;

	var B787_10_FMC_PayloadManagerPage$1 = {};

	Object.defineProperty(B787_10_FMC_PayloadManagerPage$1, "__esModule", { value: true });
	B787_10_FMC_PayloadManagerPage$1.B787_10_FMC_PayloadManagerPage = void 0;
	const B787_10_FMC_HeavyPage_1$2 = B787_10_FMC_HeavyPage$1;
	const HDSDK$3 = hdsdk;
	class B787_10_FMC_PayloadManagerPage {
	    ...
	    showPage() {
	        ...
	        let units;
	        let payloadModifier;
	        let useImperial = HDSDK$3.HeavyDivision.Configuration.useImperial();
	        if (useImperial) {
	        ...
	        this.fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_HeavyPage_1$2.B787_10_FMC_HeavyPage.ShowPage1(this.fmc);
	        };
	        if (B787_10_FMC_PayloadManagerPage.isPayloadManagerExecuted) {
	            rows[11][1] = 'RUNNING...';
	        }
	...
	B787_10_FMC_PayloadManagerPage$1.B787_10_FMC_PayloadManagerPage = B787_10_FMC_PayloadManagerPage;
	...
	var B787_10_FMC_HeavyConfigurationPage$1 = {};

	var B787_10_FMC_SimBriefConfigurationPage$1 = {};

	Object.defineProperty(B787_10_FMC_SimBriefConfigurationPage$1, "__esModule", { value: true });
	B787_10_FMC_SimBriefConfigurationPage$1.B787_10_FMC_SimBriefConfigurationPage = void 0;
	const B787_10_FMC_HeavyConfigurationPage_1$1 = B787_10_FMC_HeavyConfigurationPage$1;
	const BaseFMC_1 = BaseFMC$1;
	const HDSDK$2 = hdsdk;
	class B787_10_FMC_SimBriefConfigurationPage {
	    ...
	    showPage() {
	        ...
	        let routeOnlyCell = (HDSDK$2.HeavyDivision.SimBrief.importRouteOnly() ?
	        ...
	        let withSidCell = (HDSDK$2.HeavyDivision.SimBrief.importSid() ?
	            `${this.fmc.resizeContent(this.fmc.colorizeContent('<YES', 'green'), 'large')}←→${this.fmc.resizeContent('NO', 'small')}` :
	            `${this.fmc.resizeContent('<YES', 'small')}←→${this.fmc.resizeContent(this.fmc.colorizeContent('NO', 'green'), 'large')}`);
	        let withStarCell = (HDSDK$2.HeavyDivision.SimBrief.importStar() ?
	            `${this.fmc.resizeContent(this.fmc.colorizeContent('<YES', 'green'), 'large')}←→${this.fmc.resizeContent('NO', 'small')}` :
	            `${this.fmc.resizeContent('<YES', 'small')}←→${this.fmc.resizeContent(this.fmc.colorizeContent('NO', 'green'), 'large')}`);
	        let importStrategyCell = (HDSDK$2.HeavyDivision.SimBrief.importStrategy() === 'INGAME' ?
	    ...
	    setupInputHandlers() {
	        this.fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_HeavyConfigurationPage_1$1.B787_10_FMC_HeavyConfigurationPage.ShowPage1(this.fmc);
	        };
	        this.fmc._renderer.rsk(1).event = () => {
	            let value = this.fmc.inOut;
	            if (value === BaseFMC_1.BaseFMC.clrValue) {
	                this.fmc.inOut = '';
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_USERNAME', '');
	            }
	            else if (value.length > 0) {
	                this.fmc.clearUserInput();
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_USERNAME', value);
	            }
	            this.showPage();
	        };
	        this.fmc._renderer.rsk(2).event = () => {
	            ...
	            if (value === BaseFMC_1.BaseFMC.clrValue) {
	                this.fmc.inOut = '';
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_USERID', '');
	            }
	            else if (value.length > 0) {
	                this.fmc.clearUserInput();
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_USERID', value);
	            }
	            this.showPage();
	        };
	        this.fmc._renderer.lsk(1).event = () => {
	            if (HDSDK$2.HeavyDivision.SimBrief.importRouteOnly()) {
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_ROUTE_ONLY', '0');
	            }
	            else {
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_ROUTE_ONLY', '1');
	            }
	            this.showPage();
	        };
	        this.fmc._renderer.lsk(2).event = () => {
	            if (HDSDK$2.HeavyDivision.SimBrief.importSid()) {
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_WITH_SID', '0');
	            }
	            else {
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_WITH_SID', '1');
	            }
	            this.showPage();
	        };
	        this.fmc._renderer.lsk(3).event = () => {
	            if (HDSDK$2.HeavyDivision.SimBrief.importStar()) {
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_WITH_STAR', '0');
	            }
	            else {
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_WITH_STAR', '1');
	            }
	            this.showPage();
	        };
	        this.fmc._renderer.lsk(4).event = () => {
	            if (HDSDK$2.HeavyDivision.SimBrief.importStrategy() === 'INGAME') {
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_IMPORT_STRATEGY', 'SB');
	            }
	            else {
	                HDSDK$2.HeavyDataStorage.set('SIMBRIEF_IMPORT_STRATEGY', 'INGAME');
	            }
	            this.showPage();
	        };
	    }
	    getSimBriefUsernameCell() {
	        let cell = '-----';
	        let username = HDSDK$2.HeavyDataStorage.get('SIMBRIEF_USERNAME', '');
	        if (username) {
	    ...
	    getSimBriefUserIdCell() {
	        let cell = '-----';
	        let userid = HDSDK$2.HeavyDataStorage.get('SIMBRIEF_USERID', '');
	        if (userid) {
	...
	B787_10_FMC_SimBriefConfigurationPage$1.B787_10_FMC_SimBriefConfigurationPage = B787_10_FMC_SimBriefConfigurationPage;

	Object.defineProperty(B787_10_FMC_HeavyConfigurationPage$1, "__esModule", { value: true });
	B787_10_FMC_HeavyConfigurationPage$1.B787_10_FMC_HeavyConfigurationPage = void 0;
	const B787_10_FMC_HeavyPage_1$1 = B787_10_FMC_HeavyPage$1;
	const B787_10_FMC_SimBriefConfigurationPage_1 = B787_10_FMC_SimBriefConfigurationPage$1;
	const HDSDK$1 = hdsdk;
	class B787_10_FMC_HeavyConfigurationPage {
	    static ShowPage1(fmc) {
	        fmc.cleanUpPage();
	        let fpSyncCell = '';
	        switch (HDSDK$1.HeavyDivision.Configuration.activeFlightPlanSynchronizationStrategy()) {
	            case 0:
	        ...
	        let unitsCell = (HDSDK$1.HeavyDivision.Configuration.useImperial() ? '[color=green]IMPERIAL[/color]←→[size=small]METRIC[/size]>' : '[size=small]IMPERIAL[/size]←→[color=green]METRIC[/color]>');
	        let focusableScratchpadCell = (HDSDK$1.HeavyDivision.Configuration.isFocusableScratchpadEnabled() ? '[color=green]ENABLED[/color]←→[size=small]DISABLED[/size]>' : '[size=small]ENABLED[/size]←→[color=green]DISABLED[/color]>');
	    ...
	    static setupInputHandlers(fmc) {
	        fmc._renderer.lsk(6).event = () => {
	            B787_10_FMC_HeavyPage_1$1.B787_10_FMC_HeavyPage.ShowPage1(fmc);
	        };
	        fmc._renderer.rsk(1).event = () => {
	            new B787_10_FMC_SimBriefConfigurationPage_1.B787_10_FMC_SimBriefConfigurationPage(fmc).showPage();
	        };
	        fmc._renderer.rsk(2).event = () => {
	            switch (HDSDK$1.HeavyDivision.Configuration.activeFlightPlanSynchronizationStrategy()) {
	                case 0:
	                    HDSDK$1.HeavyDataStorage.set('FP_SYNCHRONIZATION_STRATEGY', '1');
	                    break;
	                case 1:
	                    HDSDK$1.HeavyDataStorage.set('FP_SYNCHRONIZATION_STRATEGY', '0');
	                    break;
	                case 2:
	                    HDSDK$1.HeavyDataStorage.set('FP_SYNCHRONIZATION_STRATEGY', '0');
	                    break;
	        ...
	        fmc._renderer.rsk(3).event = () => {
	            if (HDSDK$1.HeavyDivision.Configuration.useImperial()) {
	                HDSDK$1.HeavyDataStorage.set('USE_IMPERIAL', '0');
	            }
	            else {
	                HDSDK$1.HeavyDataStorage.set('USE_IMPERIAL', '1');
	            }
	            B787_10_FMC_HeavyConfigurationPage.ShowPage1(fmc);
	        };
	        fmc._renderer.rsk(4).event = () => {
	            if (HDSDK$1.HeavyDivision.Configuration.isFocusableScratchpadEnabled()) {
	                HDSDK$1.HeavyDataStorage.set('IS_FOCUSABLE_SCRATCHPAD_ENABLED', '0');
	                fmc.disableFocusableScratchpad();
	            }
	            else {
	                fmc.enableFocusableScratchpad();
	                HDSDK$1.HeavyDataStorage.set('IS_FOCUSABLE_SCRATCHPAD_ENABLED', '1');
	            }
	            B787_10_FMC_HeavyConfigurationPage.ShowPage1(fmc);
	        };
	    }
	    static isSimBriefFilled() {
	        let username = HDSDK$1.HeavyDataStorage.get('SIMBRIEF_USERNAME', '');
	        let userid = HDSDK$1.HeavyDataStorage.get('SIMBRIEF_USERID', '');
	        return (username !== '' || userid !== '');
	    }
	}
	B787_10_FMC_HeavyConfigurationPage$1.B787_10_FMC_HeavyConfigurationPage = B787_10_FMC_HeavyConfigurationPage;

	var B787_10_FMC_LNAVDebug$1 = {};

	var LNAV$1 = {};

	Object.defineProperty(LNAV$1, "__esModule", { value: true });
	LNAV$1.LNAV = void 0;
	class LNAV {
	    constructor() {
	    }
	...
	Object.defineProperty(B787_10_FMC_LNAVDebug$1, "__esModule", { value: true });
	B787_10_FMC_LNAVDebug$1.B787_10_FMC_LNAVDebug = void 0;
	const LNAV_1 = LNAV$1;
	const hdlogger_1$2 = hdlogger;
	const level_1$2 = level;
	/**
	...
	class B787_10_FMC_LNAVDebug {
	    static async showPage(fmc) {
	        fmc.cleanUpPage();
	        hdlogger_1$2.HDLogger.log('AP MANAGED MODE: ' + SimVar.GetSimVarValue('AUTOPILOT AVIONICS MANAGED', 'number'), level_1$2.Level.debug);
	        hdlogger_1$2.HDLogger.log('WING LEVELER: ' + SimVar.GetSimVarValue('AUTOPILOT WING LEVELER', 'number'), level_1$2.Level.debug);
	        hdlogger_1$2.HDLogger.log('BANK REF: ' + SimVar.GetSimVarValue('AUTOPILOT BANK HOLD REF', 'degrees'), level_1$2.Level.debug);
	        hdlogger_1$2.HDLogger.log('BANK HOLD: ' + SimVar.GetSimVarValue('AUTOPILOT BANK HOLD', 'Bool'), level_1$2.Level.debug);
	        hdlogger_1$2.HDLogger.log('PITCH REF: ' + SimVar.GetSimVarValue('AUTOPILOT PITCH HOLD REF', 'degrees'), level_1$2.Level.debug);
	        hdlogger_1$2.HDLogger.log('PITCH HOLD: ' + SimVar.GetSimVarValue('AUTOPILOT PITCH HOLD', 'Bool'), level_1$2.Level.debug);
	        hdlogger_1$2.HDLogger.log('APPROACH HOLD: ' + SimVar.GetSimVarValue('AUTOPILOT APPROACH HOLD', 'boolean'), level_1$2.Level.debug);
	        fmc.pageUpdate = () => {
	            this.updater += 1;
	            if (this.updater > 10) {
	                this.updater = 0;
	...
	B787_10_FMC_LNAVDebug$1.B787_10_FMC_LNAVDebug = B787_10_FMC_LNAVDebug;
	B787_10_FMC_LNAVDebug.lnav = new LNAV_1.LNAV();
	B787_10_FMC_LNAVDebug.updater = 0;

	Object.defineProperty(B787_10_FMC_HeavyPage$1, "__esModule", { value: true });
	B787_10_FMC_HeavyPage$1.B787_10_FMC_HeavyPage = void 0;
	const B787_10_FMC_HeavyIRSPage_1 = B787_10_FMC_HeavyIRSPage$1;
	const B787_10_FMC_PayloadManagerPage_1 = B787_10_FMC_PayloadManagerPage$1;
	const B787_10_FMC_HeavyConfigurationPage_1 = B787_10_FMC_HeavyConfigurationPage$1;
	const B787_10_FMC_LNAVDebug_1 = B787_10_FMC_LNAVDebug$1;
	class B787_10_FMC_HeavyPage {
	    static ShowPage1(fmc) {
	        ...
	        if (!B787_10_FMC_HeavyPage.WITHOUT_MANAGERS) {
	            ...
	            fmc._renderer.rsk(1).event = () => {
	                new B787_10_FMC_HeavyIRSPage_1.B787_10_FMC_HeavyIRSPage(fmc).showPage();
	            };
	            fmc._renderer.rsk(2).event = () => {
	                new B787_10_FMC_PayloadManagerPage_1.B787_10_FMC_PayloadManagerPage(fmc).showPage();
	            };
	            /*
	             fmc._renderer.rsk(3).event = () => {
	        ...
	        fmc._renderer.rsk(3).event = () => {
	            B787_10_FMC_LNAVDebug_1.B787_10_FMC_LNAVDebug.showPage(fmc);
	        };
	        fmc._renderer.rsk(6).event = () => {
	            B787_10_FMC_HeavyConfigurationPage_1.B787_10_FMC_HeavyConfigurationPage.ShowPage1(fmc);
	        };
	        fmc._renderer.renderTitle('HEAVY MENU');
	        fmc._renderer.render(rows);
	    }
	}
	B787_10_FMC_HeavyPage$1.B787_10_FMC_HeavyPage = B787_10_FMC_HeavyPage;
	B787_10_FMC_HeavyPage.WITHOUT_MANAGERS = false;

	var B787_10_FMC_DepArrPage$1 = {};

	Object.defineProperty(B787_10_FMC_DepArrPage$1, "__esModule", { value: true });
	B787_10_FMC_DepArrPage$1.B787_10_FMC_DepArrPage = void 0;
	const B787_10_FMC_RoutePage_1$1 = B787_10_FMC_RoutePage$1;
	const hdlogger_1$1 = hdlogger;
	const level_1$1 = level;
	class B787_10_FMC_DepArrPage {
	    ...
	    static ShowDeparturePage(fmc, currentPage = 1) {
	        ...
	        fmc._renderer.rsk(6).event = () => {
	            B787_10_FMC_RoutePage_1$1.B787_10_FMC_RoutePage.ShowPage1(fmc);
	        };
	    ...
	    static ShowArrivalPage(fmc, currentPage = 1) {
	        ...
	        if (selectedApproach) {
	            ...
	            for (let i = 0; i < approachPages[displayedPageIndex].length; i++) {
	                ...
	                hdlogger_1$1.HDLogger.log('approachIndex ' + approachIndex, level_1$1.Level.debug);
	                rows[2 * i] = ['', '', '', approachPages[displayedPageIndex][i].text];
	                fmc._renderer.rsk(i + 1).event = () => {
	                    if (approachIndex <= lastApproachIndex) {
	                        hdlogger_1$1.HDLogger.log('approachIndex <= lastApproachIndex', level_1$1.Level.debug);
	                        fmc.flightPlanManager.pauseSync();
	                        hdlogger_1$1.HDLogger.log('approachIndex ' + approachIndex, level_1$1.Level.debug);
	                        fmc.setApproachIndex(approachIndex, () => {
	                            hdlogger_1$1.HDLogger.log('approach index set, selecting arrival', level_1$1.Level.debug);
	                            if (selectedArrival) {
	                                let landingRunway = fmc.flightPlanManager.getApproachRunway();
	                                hdlogger_1$1.HDLogger.log('approach runway: ' + landingRunway.designation, level_1$1.Level.debug);
	                                if (landingRunway) {
	                                    let arrivalRunwayIndex = selectedArrival.runwayTransitions.findIndex(t => {
	                                        return t.name.indexOf('RW' + landingRunway.designation) != -1;
	                                    });
	                                    hdlogger_1$1.HDLogger.log('arrivalRunwayIndex ' + arrivalRunwayIndex, level_1$1.Level.debug);
	                                    if (arrivalRunwayIndex >= -1) {
	                        ...
	                        fmc.flightPlanManager.pauseSync();
	                        fmc.ensureCurrentFlightPlanIsTemporary(() => {
	                            hdlogger_1$1.HDLogger.log('starting to set vfrLandingRunway', level_1$1.Level.debug);
	                            fmc.modVfrRunway = true;
	                            ...
	                            fmc.flightPlanManager.setDestinationRunwayIndex(runwayApproachIndex, fmc.vfrRunwayExtension, () => {
	                                ...
	                                hdlogger_1$1.HDLogger.log('completed setting vfrLandingRunway', level_1$1.Level.debug);
	                                fmc.flightPlanManager.resumeSync();
	                                fmc.activateRoute();
	                                B787_10_FMC_DepArrPage.ShowArrivalPage(fmc);
	                            });
	        ...
	        if (selectedArrival) {
	            hdlogger_1$1.HDLogger.log('Selected Arrival', level_1$1.Level.debug);
	...
	B787_10_FMC_DepArrPage$1.B787_10_FMC_DepArrPage = B787_10_FMC_DepArrPage;

	var CJ4_FMC_PilotWaypoint_Manager$1 = {};

	Object.defineProperty(CJ4_FMC_PilotWaypoint_Manager$1, "__esModule", { value: true });
	CJ4_FMC_PilotWaypoint_Manager$1.CJ4_FMC_PilotWaypoint_Manager = void 0;
	...
	CJ4_FMC_PilotWaypoint_Manager$1.CJ4_FMC_PilotWaypoint_Manager = CJ4_FMC_PilotWaypoint_Manager;
	/**
	...
	Object.defineProperty(B787_10_FMC$1, "__esModule", { value: true });
	B787_10_FMC$1.B787_10_FMC = void 0;
	const Boeing_FMC_1 = Boeing_FMC$1;
	const B787_10_FMC_InitRefIndexPage_1 = B787_10_FMC_InitRefIndexPage$1;
	const B787_10_FMC_LegsPage_1 = B787_10_FMC_LegsPage$1;
	const B787_10_FMC_NavRadioPage_1 = B787_10_FMC_NavRadioPage$1;
	const B787_10_FMC_VNAVPage_1 = B787_10_FMC_VNAVPage$1;
	const B787_10_FMC_RoutePage_1 = B787_10_FMC_RoutePage$1;
	const B787_10_FMC_PerfInitPage_1 = B787_10_FMC_PerfInitPage$1;
	const B787_10_FMC_ProgressPage_1 = B787_10_FMC_ProgressPage$1;
	const B787_10_FMC_FMCCommPage_1 = B787_10_FMC_FMCCommPage$1;
	const B787_10_FMC_HoldsPage_1 = B787_10_FMC_HoldsPage$1;
	const B787_10_FMC_HeavyPage_1 = B787_10_FMC_HeavyPage$1;
	const B787_10_FMC_DepArrPage_1 = B787_10_FMC_DepArrPage$1;
	const CJ4_FMC_PilotWaypoint_Manager_1 = CJ4_FMC_PilotWaypoint_Manager$1;
	const B787_10_FMC_IdentPage_1 = B787_10_FMC_IdentPage$1;
	const HDSDK = hdsdk;
	const hdlogger_1 = hdlogger;
	const level_1 = level;
	const B787_10_FMC_SelectWptPage_1 = B787_10_FMC_SelectWptPage$1;
	class B787_10_FMC extends Boeing_FMC_1.Boeing_FMC {
	    /**
	    ...
	    constructor() {
	        ...
	        this.onInputAircraftSpecific = (input) => {
	            hdlogger_1.HDLogger.log('B787_10_FMC.onInputAircraftSpecific input = \'' + input + '\'', level_1.Level.info);
	            if (input === 'LEGS') {
	                if (this.onLegs) {
	                    this.onLegs();
	                }
	    ...
	    connectedCallback() {
	        ...
	        RegisterViewListener('JS_LISTENER_KEYEVENT', () => {
	            hdlogger_1.HDLogger.log('JS_LISTENER_KEYEVENT registered.', level_1.Level.info);
	            RegisterViewListener('JS_LISTENER_FACILITY', () => {
	                hdlogger_1.HDLogger.log('JS_LISTENER_FACILITY registered.', level_1.Level.info);
	    ...
	    Init() {
	        ...
	        if (this.urlConfig.index == 1) {
	            ...
	            this.onInit = () => {
	                B787_10_FMC_InitRefIndexPage_1.B787_10_FMC_InitRefIndexPage.ShowPage1(this);
	            };
	            this.onLegs = () => {
	                B787_10_FMC_LegsPage_1.B787_10_FMC_LegsPage.ShowPage1(this);
	            };
	            this.onRte = () => {
	                B787_10_FMC_RoutePage_1.B787_10_FMC_RoutePage.ShowPage1(this);
	            };
	            this.onRad = () => {
	                B787_10_FMC_NavRadioPage_1.B787_10_FMC_NavRadioPage.ShowPage(this);
	            };
	            this.onVNAV = () => {
	                new B787_10_FMC_VNAVPage_1.B787_10_FMC_VNAVPage(this).showPage();
	            };
	            ...
	            this._renderer.mk(1).event = () => {
	                if (Simplane.getIsGrounded()) {
	                    B787_10_FMC_PerfInitPage_1.B787_10_FMC_PerfInitPage.ShowPage1(this);
	                }
	                else {
	                    B787_10_FMC_InitRefIndexPage_1.B787_10_FMC_InitRefIndexPage.ShowPage1(this);
	                }
	            ...
	            this._renderer.mk(3).event = () => {
	                B787_10_FMC_DepArrPage_1.B787_10_FMC_DepArrPage.ShowPage1(this);
	            };
	            this._renderer.mk(4).event = () => {
	                hdlogger_1.HDLogger.log('NOT IMPLEMENTED', level_1.Level.info);
	            };
	            ...
	            this._renderer.mk(8).event = () => {
	                B787_10_FMC_HoldsPage_1.B787_10_FMC_HoldsPage.handleHoldPressed(this);
	            };
	            this._renderer.mk(9).event = () => {
	                B787_10_FMC_FMCCommPage_1.B787_10_FMC_FMCCommPage.ShowPage1(this);
	            };
	            this._renderer.mk(10).event = () => {
	                B787_10_FMC_ProgressPage_1.B787_10_FMC_ProgressPage.ShowPage1(this);
	            };
	            ...
	            this._renderer.mk(14).event = () => {
	                if (!B787_10_FMC_HeavyPage_1.B787_10_FMC_HeavyPage.WITHOUT_MANAGERS) {
	                    B787_10_FMC_HeavyPage_1.B787_10_FMC_HeavyPage.ShowPage1(this);
	                }
	            };
	...
	*/
	        this._pilotWaypoints = new CJ4_FMC_PilotWaypoint_Manager_1.CJ4_FMC_PilotWaypoint_Manager(this);
	        this._pilotWaypoints.activate();
	        B787_10_FMC_IdentPage_1.B787_10_FMC_IdentPage.ShowPage1(this);
	    }
	    onPowerOn() {
	        super.onPowerOn();
	        this.deactivateLNAV();
	    ...
	    getOrSelectWaypointByIdent(ident, callback) {
	        this.dataManager.GetWaypointsByIdent(ident).then((waypoints) => {
	            ...
	            B787_10_FMC_SelectWptPage_1.B787_10_FMC_SelectWptPage.ShowPage(this, waypoints, callback);
	        });
	    }
	}
	B787_10_FMC$1.B787_10_FMC = B787_10_FMC;
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	__exportStar(B787_10_FMC$1, exports);
	}(hdfmc));

	var index = /*@__PURE__*/getDefaultExportFromCjs(hdfmc);
