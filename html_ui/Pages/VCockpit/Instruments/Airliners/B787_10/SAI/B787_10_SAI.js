class B787_10_SAI extends BaseAirliners {
    get templateID() { return "B787_10_SAI"; }
    get instrumentAlias() { return "AS01B_SAI"; }
    connectedCallback() {
        super.connectedCallback();
        this.addIndependentElementContainer(new NavSystemElementContainer("Altimeter", "Altimeter", new B787_10_SAI_Altimeter()));
        this.addIndependentElementContainer(new NavSystemElementContainer("Airspeed", "Airspeed", new B787_10_SAI_Airspeed()));
        this.addIndependentElementContainer(new NavSystemElementContainer("Horizon", "Horizon", new B787_10_SAI_Attitude()));
...
class B787_10_SAI_BaroIndicator extends HTMLElement {
    constructor() {
        super(...arguments);
        ...
        this.construct = () => {
                ...
                this.line = document.createElementNS(Avionics.SVG.NS, "text");
            {
                ...
                diffAndSetAttribute(this.line, "fill", "#24F000");
...
customElements.define('b787-10-sai-baro-indicator', B787_10_SAI_BaroIndicator);
class B787_10_SAI_Compass extends NavSystemElement {
    constructor() {
        super();
    }
    init(root) {
...
class B787_10_SAI_CompassBackground extends HTMLElement {
    constructor() {
        super(...arguments);
        this.viewboxWidth = 250;
        this.viewboxHeight = 250;
...
customElements.define('b787-10-sai-compass-background', B787_10_SAI_CompassBackground);
class B787_10_SAI_HSIndicator extends HTMLElement {
    constructor() {
        super(...arguments);
...
customElements.define('b787-10-sai-hsindicator', B787_10_SAI_HSIndicator);
class B787_10_SAI_Airspeed extends NavSystemElement {
    constructor() {
        super();
    }
    init(root) {
...
class B787_10_SAI_AirspeedIndicator extends HTMLElement {
    constructor() {
        super(...arguments);
...
customElements.define('b787-10-sai-airspeed-indicator', B787_10_SAI_AirspeedIndicator);
class B787_10_SAI_Altimeter extends NavSystemElement {
    constructor() {
        super();
    }
    init(root) {
...
class B787_10_SAI_AltimeterIndicator extends HTMLElement {
    constructor() {
        super(...arguments);
        this.fontSize = 24;
        this.backgroundColor = "#37474f";
...
customElements.define('b787-10-sai-altimeter-indicator', B787_10_SAI_AltimeterIndicator);
class B787_10_SAI_Attitude extends NavSystemElement {
    init(root) {
...
class B787_10_SAI_AttitudeIndicator extends HTMLElement {
    constructor() {
        super();
...
customElements.define('b787-10-sai-attitude-indicator', B787_10_SAI_AttitudeIndicator);
registerInstrument("b787-10-sai", B787_10_SAI);
//# sourceMappingURL=B787_10_SAI.js.map