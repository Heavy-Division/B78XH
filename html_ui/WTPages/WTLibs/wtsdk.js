(function (global, factory) {
    ...
    ***************************************************************************** */
	...
	WorldMagneticModel.prototype.declination = function (altitudeKm, latitudeDegrees, longitudeDegrees, yearFloat) {
		...
		var dec;
		var n, m;
		var pi, dt, rlon, rlat, srlon, srlat, crlon, crlat, srlat2, crlat2, q, q1, q2, ct, d, aor, ar, br, r, r2, bpp,
			par, temp1, parp, temp2, bx, by, dtr, bp, bt, st, ca, sa;
		var maxord = 12;
		var alt = altitudeKm;
	...
	class ManagedFlightPlan {
		...
		buildApproach() {
			return __awaiter(this, void 0, void 0, function* () {
				...
				let {
					startIndex: missedStartIndex,
					segment: missedSegment
				} = this.truncateSegment(exports.SegmentType.Missed);
		...
		static sha256(r) {
			...
			for (a[a.length] = l / e | 0, a[a.length] = l, n = 0; n < a.length;) {
				...
				for (g = g.slice(0, 8), h = 0; h < 64; h++) {
					var d = v[h - 15], p = v[h - 2], w = g[0], A = g[4],
						C = g[7] + (t(A, 6) ^ t(A, 11) ^ t(A, 25)) + (A & g[5] ^ ~A & g[6]) + c[h] + (v[h] = h < 16 ? v[h] : v[h - 16] + (t(d, 7) ^ t(d, 18) ^ d >>> 3) + v[h - 7] + (t(p, 17) ^ t(p, 19) ^ p >>> 10) | 0);
